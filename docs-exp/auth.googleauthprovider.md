...
Provider for generating an an [OAuthCredential](./auth.oauthcredential.md) for [ProviderId](./auth.providerid.md)<!-- -->.GOOGLE.
...
|  --- | --- | --- | --- |
|  [GOOGLE\_SIGN\_IN\_METHOD](./auth.googleauthprovider.google_sign_in_method.md) | <code>static</code> | 'google.com' | Always set to [SignInMethod](./auth.signinmethod.md)<!-- -->.GOOGLE. |
|  [PROVIDER\_ID](./auth.googleauthprovider.provider_id.md) | <code>static</code> | 'google.com' | Always set to [ProviderId](./auth.providerid.md)<!-- -->.GOOGLE. |
