...
|  --- | --- |
|  [connectStorageEmulator(storage, host, port)](./storage.connectstorageemulator.md) | Modify this <code>StorageService</code> instance to communicate with the Cloud Storage emulator. |
...
|  --- | --- |
|  [FirebaseStorage](./storage.firebasestorage.md) | A Firebase Storage instance. |
