...
|  --- | --- | --- |
|  [operationType](./auth.multifactorerror.operationtype.md) | typeof [OperationTypeMap](./auth.operationtype.md)<!-- -->\[keyof typeof [OperationTypeMap](./auth.operationtype.md)<!-- -->\] | The type of operation (e.g., sign-in, link, or reauthenticate) during which the error was raised. |
