...
|  eventName | 'share' |  |
|  eventParams | { method?: [EventParams](./analytics.eventparams.md)<!-- -->\['method'\]; content\_type?: [EventParams](./analytics.eventparams.md)<!-- -->\['content\_type'\]; item\_id?: [EventParams](./analytics.eventparams.md)<!-- -->\['item\_id'\]; \[key: string\]: any; } |  |
