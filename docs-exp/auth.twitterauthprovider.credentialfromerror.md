...
[Home](./index.md) &gt; [@firebase/auth](./auth.md) &gt; [TwitterAuthProvider](./auth.twitterauthprovider.md) &gt; [credentialFromError](./auth.twitterauthprovider.credentialfromerror.md)
