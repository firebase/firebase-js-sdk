...
|  --- | --- | --- | --- |
|  [converter](./firestore_.documentreference.converter.md) |  | [FirestoreDataConverter](./firestore_.firestoredataconverter.md)<!-- -->&lt;T&gt; \| null | If provided, the <code>FirestoreDataConverter</code> associated with this instance. |
|  [firestore](./firestore_.documentreference.firestore.md) |  | [Firestore](./firestore_.firestore.md) | The  the document is in. This is useful for performing transactions, for example. |
