...
|  [operation](./auth.actioncodeinfo.operation.md) | typeof [ActionCodeOperationMap](./auth.actioncodeoperation.md)<!-- -->\[keyof typeof [ActionCodeOperationMap](./auth.actioncodeoperation.md)<!-- -->\] | The type of operation that generated the action code. |
