...
|  --- | --- | --- | --- |
|  [PHONE\_SIGN\_IN\_METHOD](./auth.phoneauthprovider.phone_sign_in_method.md) | <code>static</code> | 'phone' | Always set to [SignInMethod](./auth.signinmethod.md)<!-- -->.PHONE. |
|  [PROVIDER\_ID](./auth.phoneauthprovider.provider_id.md) | <code>static</code> | 'phone' | Always set to [ProviderId](./auth.providerid.md)<!-- -->.PHONE. |
|  [providerId](./auth.phoneauthprovider.providerid.md) |  | "phone" | Always set to [ProviderId](./auth.providerid.md)<!-- -->.PHONE. |
