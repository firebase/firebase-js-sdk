...
|  --- | --- | --- |
|  storageOrRef | [FirebaseStorage](./storage.firebasestorage.md) \| [StorageReference](./storage.storagereference.md) | <code>StorageService</code> or <code>StorageReference</code>. |
|  path | string |  |
