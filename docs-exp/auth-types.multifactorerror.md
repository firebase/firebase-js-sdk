...
```
<b>Extends:</b> [AuthError](./auth-types.autherror.md#autherror-interface)
...
|  --- | --- | --- |
|  [operationType](./auth-types.multifactorerror.md#multifactorerroroperationtype-property) | [OperationType](./auth-types.md#operationtype-enum) | The type of operation (e.g., sign-in, link, or reauthenticate) during which the error was raised. |
