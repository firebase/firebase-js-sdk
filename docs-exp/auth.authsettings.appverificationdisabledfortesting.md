...
[Home](./index.md) &gt; [@firebase/auth](./auth.md) &gt; [AuthSettings](./auth.authsettings.md) &gt; [appVerificationDisabledForTesting](./auth.authsettings.appverificationdisabledfortesting.md)
