...
|  [settings](./remote-config.remoteconfig.settings.md) | [RemoteConfigSettings](./remote-config.remoteconfigsettings.md) | Defines configuration for the Remote Config SDK. |
