...
|  --- | --- | --- |
|  [isEqual(other)](./firestore_lite.fieldpath.md#fieldpathisequal-method) |  | Returns true if this <code>FieldPath</code> is equal to the provided one. |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  other | [FieldPath](./firestore_lite.fieldpath.md#fieldpath-class) | The <code>FieldPath</code> to compare against. |
