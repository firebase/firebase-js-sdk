...
```typescript
export declare function list(ref: types.StorageReference, options?: types.ListOptions): Promise<types.ListResult>;
```
...
|  options | types.ListOptions | See ListOptions for details. |
