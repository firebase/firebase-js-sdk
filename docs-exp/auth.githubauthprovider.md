...
Provider for generating an [OAuthCredential](./auth.oauthcredential.md) for [ProviderId](./auth.providerid.md)<!-- -->.GITHUB.
...
|  --- | --- | --- | --- |
|  [GITHUB\_SIGN\_IN\_METHOD](./auth.githubauthprovider.github_sign_in_method.md) | <code>static</code> | 'github.com' | Always set to [SignInMethod](./auth.signinmethod.md)<!-- -->.GITHUB. |
|  [PROVIDER\_ID](./auth.githubauthprovider.provider_id.md) | <code>static</code> | 'github.com' | Always set to [ProviderId](./auth.providerid.md)<!-- -->.GITHUB. |
