...
|  eventParams | { currency?: [EventParams](./analytics.eventparams.md)<!-- -->\['currency'\]; items?: [EventParams](./analytics.eventparams.md)<!-- -->\['items'\]; value?: [EventParams](./analytics.eventparams.md)<!-- -->\['value'\]; \[key: string\]: any; } |  |
