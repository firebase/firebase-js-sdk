...
Provider for generating an [OAuthCredential](./auth.oauthcredential.md) for [ProviderId](./auth.providerid.md)<!-- -->.FACEBOOK.
...
|  --- | --- | --- | --- |
|  [FACEBOOK\_SIGN\_IN\_METHOD](./auth.facebookauthprovider.facebook_sign_in_method.md) | <code>static</code> | 'facebook.com' | Always set to [SignInMethod](./auth.signinmethod.md)<!-- -->.FACEBOOK. |
|  [PROVIDER\_ID](./auth.facebookauthprovider.provider_id.md) | <code>static</code> | 'facebook.com' | Always set to [ProviderId](./auth.providerid.md)<!-- -->.FACEBOOK. |
