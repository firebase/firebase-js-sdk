...
|  [type](./firestore_.collectionreference.type.md) |  | (not declared) | The type of this Firestore reference. |
...
|  [withConverter(converter)](./firestore_.collectionreference.withconverter_1.md) |  | Removes the current converter. |
