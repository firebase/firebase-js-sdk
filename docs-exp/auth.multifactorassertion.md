...
|  --- | --- | --- |
|  [factorId](./auth.multifactorassertion.factorid.md) | typeof [FactorIdMap](./auth.factorid.md)<!-- -->\[keyof typeof [FactorIdMap](./auth.factorid.md)<!-- -->\] | The identifier of the second factor. |
