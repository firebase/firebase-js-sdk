...
[Home](./index.md) &gt; [@firebase/messaging](./messaging.md) &gt; [/](./messaging_.md) &gt; [getToken](./messaging_.gettoken.md)
...
|  options | [GetTokenOptions](./messaging_.gettokenoptions.md) | Provides an optional vapid key and an optinoal service worker registration |
