...
Provider for generating an [OAuthCredential](./auth.oauthcredential.md) for [ProviderId](./auth.providerid.md)<!-- -->.TWITTER.
...
|  --- | --- | --- | --- |
|  [PROVIDER\_ID](./auth.twitterauthprovider.provider_id.md) | <code>static</code> | 'twitter.com' | Always set to [ProviderId](./auth.providerid.md)<!-- -->.TWITTER. |
|  [TWITTER\_SIGN\_IN\_METHOD](./auth.twitterauthprovider.twitter_sign_in_method.md) | <code>static</code> | 'twitter.com' | Always set to [SignInMethod](./auth.signinmethod.md)<!-- -->.TWITTER. |
