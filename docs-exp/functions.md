...
|  --- | --- |
|  [connectFunctionsEmulator(functionsInstance, host, port)](./functions.connectfunctionsemulator.md) | Modify this instance to communicate with the Cloud Functions emulator.<!-- -->Note: this must be called before this instance has been used to do any operations. |
