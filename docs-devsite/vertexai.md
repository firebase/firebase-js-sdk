...
|  [ImagenGCSImageResponse](./vertexai.imagengcsimageresponse.md#imagengcsimageresponse_interface) | The response from a request to generate images to Google Cloud Storage (GCS). |
...
|  [ImagenInlineImageResponse](./vertexai.imageninlineimageresponse.md#imageninlineimageresponse_interface) | The response from a request to generate images to inline bytes. |
