...
|  [AIModel](./vertexai.aimodel.md#aimodel_class) | Base class for Firebase AI model APIs. |
...
|  [HarmBlockMethod](./vertexai.md#harmblockmethod) | This property is not supported in Google AI. |
...
|  [AIOptions](./vertexai.aioptions.md#aioptions_interface) | Options interface for initializing the AI service using [getAI()](./vertexai.md#getai_a94a413)<!-- -->. |
...
|  [VertexAIOptions](./vertexai.vertexaioptions.md#vertexaioptions_interface) | Options when initializing the Firebase AI SDK. |
...
|  --- | --- |
|  [BackendType](./vertexai.md#backendtype) | An enum-like object containing constants that represent the supported backends for the Firebase AI SDK.<!-- -->These values are assigned to the <code>backendType</code> property within the specific backend configuration objects ([GoogleAIBackend](./vertexai.md#googleaibackend) or [VertexAIBackend](./vertexai.md#vertexaibackend)<!-- -->) to identify which service to target. |
...
|  [GoogleAIBackend](./vertexai.md#googleaibackend) | Represents the configuration object for the Google AI backend. Use this with [AIOptions](./vertexai.aioptions.md#aioptions_interface) when initializing the service with [getAI()](./vertexai.md#getai_a94a413)<!-- -->. Create an instance using [googleAIBackend()](./vertexai.md#googleaibackend)<!-- -->. |
...
|  [VertexAI](./vertexai.md#vertexai) | An instance of the Firebase AI SDK.<!-- -->For more information, refer to the documentation for the new [AI](./vertexai.ai.md#ai_interface)<!-- -->. |
...
Returns the default [AI](./vertexai.ai.md#ai_interface) instance that is associated with the provided [FirebaseApp](./app.firebaseapp.md#firebaseapp_interface)<!-- -->. If no instance exists, initializes a new instance with the default settings.
...
|  options | [AIOptions](./vertexai.aioptions.md#aioptions_interface) | [AIOptions](./vertexai.aioptions.md#aioptions_interface) that configure the AI instance. |

<b>Returns:</b>

[AI](./vertexai.ai.md#ai_interface)

The default [AI](./vertexai.ai.md#ai_interface) instance for the given [FirebaseApp](./app.firebaseapp.md#firebaseapp_interface)<!-- -->.
...
Returns a [VertexAI](./vertexai.md#vertexai) instance for the given app.
...
For more information, refer to the documentation for the new [AIError](./vertexai.aierror.md#aierror_class)<!-- -->.
...
For more information, refer to the documentation for the new [AIModel](./vertexai.aimodel.md#aimodel_class)<!-- -->.
...
Union type representing the backend configuration for the AI service. This can be either a [GoogleAIBackend](./vertexai.md#googleaibackend) or a [VertexAIBackend](./vertexai.md#vertexaibackend) configuration object.
...
Represents the configuration object for the Google AI backend. Use this with [AIOptions](./vertexai.aioptions.md#aioptions_interface) when initializing the service with [getAI()](./vertexai.md#getai_a94a413)<!-- -->. Create an instance using [googleAIBackend()](./vertexai.md#googleaibackend)<!-- -->.
...
For more information, refer to the documentation for the new [AI](./vertexai.ai.md#ai_interface)<!-- -->.
...
Represents the configuration object for the Vertex AI backend. Use this with [AIOptions](./vertexai.aioptions.md#aioptions_interface) when initializing the server with [getAI()](./vertexai.md#getai_a94a413)<!-- -->. Create an instance using [vertexAIBackend()](./vertexai.md#vertexaibackend_d0a4534) function.
...
Standardized error codes that [AIError](./vertexai.aierror.md#aierror_class) can have.
