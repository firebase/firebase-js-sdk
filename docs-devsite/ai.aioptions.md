...
# AIOptions interface
Options for initializing the AI service using [getAI()](./ai.md#getai_a94a413)<!-- -->. This allows specifying which backend to use (Gemini Developer API or Gemini Enterprise API) and configuring its specific options (like location for Gemini Enterprise).
