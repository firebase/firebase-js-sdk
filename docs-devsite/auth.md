...
|  [signInWithPasskey(auth, name, manualSignUp)](./auth.md#signinwithpasskey) |  |
...
|  [enrollPasskey(user, name)](./auth.md#enrollpasskey) | Links the user account with the given phone number. |
