...
|  [unenrollPasskey(user, credentialId)](./auth.md#unenrollpasskey) | Unenrolls a passkey for the user account. |
...
|  [PasskeyInfo](./auth.passkeyinfo.md#passkeyinfo_interface) |  |
