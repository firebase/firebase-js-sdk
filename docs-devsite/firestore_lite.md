...
Using this function to count the documents is efficient because only the final count, not the documents' data, is downloaded. This function can count the documents if the result set would be prohibitively large to download entirely (thousands of documents).
