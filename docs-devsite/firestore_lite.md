...
|  settings | Settings | A settings object to configure the <code>Firestore</code> instance. |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  firestore | [Firestore](./firestore_.firestore.md#firestore_class) | The <code>Firestore</code> instance to terminate. |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  query | [Query](./firestore_.query.md#query_class)<!-- -->&lt;AppModelType, DbModelType&gt; | The <code>Query</code> to execute. |
