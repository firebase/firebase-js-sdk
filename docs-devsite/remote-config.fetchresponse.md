...
|  [rollouts](./remote-config.fetchresponse.md#fetchresponserollouts) | [FirebaseRolloutMetadata](./remote-config.firebaserolloutmetadata.md#firebaserolloutmetadata_interface)<!-- -->\[\] | Metadata for Remote Config Rollout experiments. |
