...
|  [variable(name)](./firestore_lite_pipelines.md#variable_1eaaff4) | <b><i>(Public Preview)</i></b> Creates an expression that retrieves the value of a variable bound via . |
|  <b>function(path, ...)</b> |
