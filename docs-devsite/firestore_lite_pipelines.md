...
|  [ltrim(expression, valueToTrim)](./firestore_lite_pipelines.md#ltrim_775e2f2) | <b><i>(Public Preview)</i></b> Trims whitespace or a specified set of characters/bytes from the start of a string or byte array. |
...
|  [ltrim(fieldName, valueToTrim)](./firestore_lite_pipelines.md#ltrim_c0e3211) | <b><i>(Public Preview)</i></b> Trims whitespace or a specified set of characters/bytes from the start of a string or byte array. |
