...
|  [parent()](./firestore_lite_pipelines.expression.md#expressionparent) |  | <b><i>(Public Preview)</i></b> Creates an expression that returns the parent of a document reference. |
