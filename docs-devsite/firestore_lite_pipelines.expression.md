...
|  [ltrim(valueToTrim)](./firestore_lite_pipelines.expression.md#expressionltrim) |  | <b><i>(Public Preview)</i></b> Trims whitespace from the beginning of a string. |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  valueToTrim | string \| [Expression](./firestore_lite_pipelines.expression.md#expression_class) \| [Bytes](./firestore_lite.bytes.md#bytes_class) |  |
