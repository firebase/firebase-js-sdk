...
|  <b>function()</b> |
|  [registerCrashlytics()](./crashlytics_.md#registercrashlytics) |  |
...
|  [getOtelLogger(crashlytics)](./crashlytics_.md#getotellogger_16fdf66) | Retrieves the OpenTelemetry Logger instance used by Crashlytics. |
|  [getOtelLoggerProvider(crashlytics)](./crashlytics_.md#getotelloggerprovider_16fdf66) | Retrieves the OpenTelemetry LoggerProvider instance used by Crashlytics. |
...
### registerCrashlytics() {:#registercrashlytics}

<b>Signature:</b>

```typescript
export declare function registerCrashlytics(): void;
```
<b>Returns:</b>
...
### getOtelLogger(crashlytics) {:#getotellogger_16fdf66}
...
```typescript
export declare function getOtelLogger(crashlytics: Crashlytics): Logger;
```
...
The underlying OpenTelemetry Logger.
