...
|  [experimentalGrpcFlowControlWindow](./firestore_.firestoresettings.md#firestoresettingsexperimentalgrpcflowcontrolwindow) | number | Sets the gRPC flow control window size in bytes. Only applicable in Node.js environments. |
...
## FirestoreSettings.experimentalGrpcFlowControlWindow
