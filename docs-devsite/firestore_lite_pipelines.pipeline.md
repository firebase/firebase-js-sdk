...
|  [delete()](./firestore_lite_pipelines.pipeline.md#pipelinedelete) |  | <b><i>(Public Preview)</i></b> Performs a delete operation on documents from previous stages. |
...
|  [insert()](./firestore_lite_pipelines.pipeline.md#pipelineinsert) |  | <b><i>(Public Preview)</i></b> Performs an insert operation using documents from previous stages. |
|  [insert(options)](./firestore_lite_pipelines.pipeline.md#pipelineinsert) |  | <b><i>(Public Preview)</i></b> Performs an insert operation with options. |
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  options | [InsertStageOptions](./firestore_lite_pipelines.md#insertstageoptions) | Options defining the collection and document ID. |
