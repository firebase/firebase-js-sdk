...
|  <b>function(value, ...)</b> |
|  [constant(value, options)](./firestore_pipelines.md#constant_6ea0dde) | Creates a <code>Constant</code> instance for a number value. |
...
|  [Stage](./firestore_pipelines.stage.md#stage_class) |  |
