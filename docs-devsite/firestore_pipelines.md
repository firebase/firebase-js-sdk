...
|  [arrayFilter(arrayExpression, variable, predicate)](./firestore_pipelines.md#arrayfilter_e51f789) | <b><i>(Public Preview)</i></b> Creates an expression that filters an array based on a predicate. |
...
|  [arrayFilter(fieldName, variable, predicate)](./firestore_pipelines.md#arrayfilter_8b982b2) | <b><i>(Public Preview)</i></b> Creates an expression that filters an array based on a predicate. |
