...
|  [isType(expression, type)](./firestore_pipelines.md#istype_e58f382) | <b><i>(Public Preview)</i></b> Creates an expression that checks if the result of an expression is of the given type. |
...
|  [isType(fieldName, type)](./firestore_pipelines.md#istype_ec95173) | <b><i>(Public Preview)</i></b> Creates an expression that checks if the value in the specified field is of the given type. |
