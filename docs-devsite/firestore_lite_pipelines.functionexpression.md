...
|  --- | --- | --- |
|  [(constructor)(name, params)](./firestore_lite_pipelines.functionexpression.md#functionexpressionconstructor) |  | <b><i>(Public Preview)</i></b> Constructs a new instance of the <code>FunctionExpression</code> class |
|  [(constructor)(name, params, \_methodName)](./firestore_lite_pipelines.functionexpression.md#functionexpressionconstructor) |  | <b><i>(Public Preview)</i></b> Constructs a new instance of the <code>FunctionExpression</code> class |

## Properties

|  Property | Modifiers | Type | Description |
|  --- | --- | --- | --- |
|  [expressionType](./firestore_lite_pipelines.functionexpression.md#functionexpressionexpressiontype) |  | [ExpressionType](./firestore_lite_pipelines.md#expressiontype) | <b><i>(Public Preview)</i></b> |
