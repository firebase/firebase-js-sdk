...
A `QueryEndAtConstraint` is used to exclude documents from the end of a result set returned by a Firestore query. `QueryEndAtConstraint`<!-- -->s are created by invoking [endAt()](./firestore_lite.md#endat_9a4477f) or [endBefore()](./firestore_lite.md#endbefore_9a4477f) and can then be passed to [query()](./firestore_lite.md#query_9f7b0f4) to create a new query instance that also contains this `QueryEndAtConstraint`<!-- -->.
