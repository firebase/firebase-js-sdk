...
| [Date_2](./ai.date_2.md#date_2_interface)                                                                               | Protobuf google.type.Date                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| [POSSIBLE_ROLES](./ai.md#possible_roles)                   | Possible roles.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
```typescript
export declare function getGenerativeModel(
  ai: AI,
...
```typescript
export declare function getImagenModel(
  ai: AI,
...
```typescript
export declare function getLiveGenerativeModel(
  ai: AI,
...
```typescript
export declare function getTemplateGenerativeModel(
  ai: AI,
  requestOptions?: RequestOptions
...
```typescript
export declare function getTemplateImagenModel(
  ai: AI,
  requestOptions?: RequestOptions
): TemplateImagenModel;
```
...
```typescript
export declare function startAudioConversation(
...
<b>URL_RETRIEVAL_STATUS_UNSPECIFIED:</b> Unspecified retrieval status. <br/> <b>URL_RETRIEVAL_STATUS_SUCCESS:</b> The URL retrieval was successful. <br/> <b>URL_RETRIEVAL_STATUS_ERROR:</b> The URL retrieval failed. <br/> <b>URL_RETRIEVAL_STATUS_PAYWALL:</b> The URL retrieval failed because the content is behind a paywall. <br/> <b>URL_RETRIEVAL_STATUS_UNSAFE:</b> The URL retrieval failed because the content is unsafe. <br/>
