...
|  [SingleSpeakerSpeechConfig](./ai.singlespeakerspeechconfig.md#singlespeakerspeechconfig_interface) | <b><i>(Public Preview)</i></b> Configuration for speech synthesis using a single voice. |
