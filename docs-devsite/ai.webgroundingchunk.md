...
|  --- | --- | --- |
|  [domain](./ai.webgroundingchunk.md#webgroundingchunkdomain) | string | The domain of the original URI from which the content was retrieved.<!-- -->This property is only supported in the Gemini Enterprise API ([EnterpriseBackend](./ai.enterprisebackend.md#enterprisebackend_class)<!-- -->). When using the Gemini Developer API ([GoogleAIBackend](./ai.googleaibackend.md#googleaibackend_class)<!-- -->), this property will be <code>undefined</code>. |
...
This property is only supported in the Gemini Enterprise API ([EnterpriseBackend](./ai.enterprisebackend.md#enterprisebackend_class)<!-- -->). When using the Gemini Developer API ([GoogleAIBackend](./ai.googleaibackend.md#googleaibackend_class)<!-- -->), this property will be `undefined`<!-- -->.
