...
|  [startChat(params)](./ai.templategenerativemodel.md#templategenerativemodelstartchat) |  | <b><i>(Public Preview)</i></b> Starts a  that will use this template to respond to messages. |
...
Starts a  that will use this template to respond to messages.
