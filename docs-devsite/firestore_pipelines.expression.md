...
|  [getField(key)](./firestore_pipelines.expression.md#expressiongetfield) |  | <b><i>(Public Preview)</i></b> Creates an expression that returns the value of a field from the document that results from the evaluation of this expression. |
