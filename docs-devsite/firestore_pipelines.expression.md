...
|  [ascending()](./firestore_pipelines.expression.md#expressionascending) |  | Creates an  that sorts documents in ascending order based on this expression. |
...
|  [descending()](./firestore_pipelines.expression.md#expressiondescending) |  | Creates an  that sorts documents in descending order based on this expression. |
...
A new  representing the difference as an integer.
...
A new  representing the extracted part as an integer.
...
A new  representing the truncated timestamp.
...
|  Parameter | Type | Description |
|  --- | --- | --- |
|  valueToTrim | string \| [Expression](./firestore_pipelines.expression.md#expression_class) \| Bytes | Optional This parameter is treated as a set of characters or bytes that will be trimmed from the input. If not specified, then whitespace will be trimmed. |
