...
|  --- | --- | --- |
|  [indexes](./firestore.indexconfiguration.md#indexconfigurationindexes) | [Index](./firestore.index.md#index_interface)<!-- -->\[\] | <b><i>(Public Preview)</i></b> A list of all Firestore indexes. |
