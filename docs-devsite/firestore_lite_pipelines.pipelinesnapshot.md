...
|  [results](./firestore_lite_pipelines.pipelinesnapshot.md#pipelinesnapshotresults) |  | PipelineResult\[\] | An array of all the results in the <code>PipelineSnapshot</code>. |
