...
|  --- | --- | --- | --- |
|  [executionTime](./firestore_lite_pipelines.pipelinesnapshot.md#pipelinesnapshotexecutiontime) |  | [Timestamp](./firestore_lite.timestamp.md#timestamp_class) | <b><i>(Public Preview)</i></b> The time at which the pipeline producing this result is executed. {<!-- -->Timestamp<!-- -->} |
...
|  --- | --- | --- |
|  pipeline | [Pipeline](./firestore_lite_pipelines.pipeline.md#pipeline_class) |  |
|  results | [PipelineResult](./firestore_lite_pipelines.pipelineresult.md#pipelineresult_class)<!-- -->\[\] |  |
|  executionTime | [Timestamp](./firestore_lite.timestamp.md#timestamp_class) |  |
