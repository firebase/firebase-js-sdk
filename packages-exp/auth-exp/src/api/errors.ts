...
export const enum ServerError {
  ...
  UNSUPPORTED_PASSTHROUGH_OPERATION = 'UNSUPPORTED_PASSTHROUGH_OPERATION',
...
export const SERVER_ERROR_MAP: Partial<ServerErrorMap<ServerError>> = {
  ...
  // This can only happen if the SDK sends an unsupported request in passthrough mode.
  [ServerError.UNSUPPORTED_PASSTHROUGH_OPERATION]:
