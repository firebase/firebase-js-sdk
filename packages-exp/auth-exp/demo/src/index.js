...
import { log, clearLogs, alertSuccess, alertError, alertNotImplemented, logAtLevel_ } from './logging';
...
function makeApplicationVerifier(submitButtonId) {
  var container = recaptchaSize === 'invisible' ?
      submitButtonId :
      'recaptcha-container';
  applicationVerifier = new RecaptchaVerifier(container,
      {'size': recaptchaSize}, auth);
}
