...
*/
goog.provide('fb.core.AuthTokenProvider');


/**
 * Abstraction around FirebaseApp's token fetching capabilities.
 */
fb.core.AuthTokenProvider = goog.defineClass(null, {
  /**
      ...
      .then(
        ...
        function(error) {
          ...
          if (error && error.code === 'auth/token-not-initialized') {
            fb.core.util.log('Got auth/token-not-initialized error.  Treating as null token.');
            return null;
          } else {
  ...
  addTokenChangeListener: function(listener) {
  ...
  notifyForInvalidToken: function() {
    ...
    fb.core.util.warn(errorMessage);
  }
});
