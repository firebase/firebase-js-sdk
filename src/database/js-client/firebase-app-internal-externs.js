 ...
 *                         (function(!Object): void)=): firebase.Service>}
 */
 ...
 *
 * @param {boolean=} opt_forceRefresh Whether to force sts token refresh.
 * @return {!Promise<?firebase.AuthTokenData>}
 */
firebase.app.App.prototype.INTERNAL.getToken = function(opt_forceRefresh) {};
