...
export class PersistentConnection extends ServerActions {
  ...
  private securityDebugCallback_: ((a: Object) => any) | null = null;
  ...
  private requestCBHash_: { [k: number]: (a: any) => any } = {};
  ...
  constructor(private repoInfo_: RepoInfo,
              ...
              private onConnectStatus_: (a: boolean) => any,
   ...
   * @protected
   */
  sendRequest(action: string, body: any, onResponse?: (a: any) => any) {
  ...
  private sendOnDisconnect_(action: string, pathString: string, data: any, onComplete: (a: string, b: string) => any) {
  ...
  putInternal(action: string, pathString: string, data: any,
              onComplete: (a: string, b: string | null) => any, hash?: string) {
    const request = {/*path*/ 'p': pathString, /*data*/ 'd': data};
  ...
  private scheduleConnect_(timeout: number) {
    ...
    this.establishConnectionTimer_ = <any>setTimeout(() => {
