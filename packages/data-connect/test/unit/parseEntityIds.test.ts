...
describe('parseEntityIds', () => {
    it('should parse single entity id', () => {
      ...
      },
      {
        ...
        // @ts-ignore
        expect(actual.data.posts[0].comments_on_post[0]._id).to.eq("idForPost1Comment1");
        // @ts-ignore
        expect(actual.data.posts[0].comments_on_post[1]._id).to.eq("idForPost1Comment2");
        // @ts-ignore
        expect(actual.data.posts[1].comments_on_post[0]._id).to.eq("idForPost2Comment1");
        // @ts-ignore
        expect(actual.data.posts[1].comments_on_post[1]._id).to.eq("idForPost2Comment2");
    });
});