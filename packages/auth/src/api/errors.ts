...
export const enum ServerError {
  ...
  PASSKEY_CHALLENGE_TIMEOUT = 'PASSKEY_CHALLENGE_TIMEOUT',
  PASSKEY_ENROLLMENT_NOT_FOUND = 'PASSKEY_ENROLLMENT_NOT_FOUND',
  INVALID_AUTHENTICATOR_RESPONSE = 'INVALID_AUTHENTICATOR_RESPONSE'
}
...
export const SERVER_ERROR_MAP: Partial<ServerErrorMap<ServerError>> = {
  ...
  [ServerError.PASSKEY_LIMIT_EXCEEDED]: AuthErrorCode.PASSKEY_LIMIT_EXCEEDED,
  [ServerError.PASSKEY_NOT_ENABLED]: AuthErrorCode.PASSKEY_NOT_ENABLED,
  [ServerError.PASSKEY_EXISTS]: AuthErrorCode.PASSKEY_EXISTS,
  [ServerError.PASSKEY_CHALLENGE_TIMEOUT]:
    AuthErrorCode.PASSKEY_CHALLENGE_TIMEOUT,
  [ServerError.PASSKEY_ENROLLMENT_NOT_FOUND]:
    AuthErrorCode.PASSKEY_ENROLLMENT_NOT_FOUND,
  [ServerError.INVALID_AUTHENTICATOR_RESPONSE]:
