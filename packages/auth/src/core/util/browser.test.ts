...
describe('core/util/browser', () => {
  describe('_getBrowserName', () => {
    it('should recognize Opera', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.OPERA);
    });
    ...
    it('should recognize IE', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.IE);
    });

    it('should recognize Edge', () => {
      const userAgent =
        'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36 Edge/12.10240';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.EDGE);
    });

    it('should recognize Firefox', () => {
      const userAgent =
        'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:46.0) Gecko/20100101 Firefox/46.0';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.FIREFOX);
    });
    ...
    it('should recognize Silk', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.SILK);
    });
    ...
    it('should recognize Safari', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.SAFARI);
    });
    ...
    it('should recognize Chrome', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.CHROME);
    });

    it('should recognize Android', () => {
      const userAgent =
        'Mozilla/5.0 (Linux; U; Android 4.0.3; ko-kr; LG-L160L Build/IML74K) AppleWebkit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.ANDROID);
    });

    it('should recognize Blackberry', () => {
      const userAgent =
        'Mozilla/5.0 (BlackBerry; U; BlackBerry 9900; en) AppleWebKit/534.11+ (KHTML, like Gecko) Version/7.1.0.346 Mobile Safari/534.11+';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.BLACKBERRY);
    });

    it('should recognize IE Mobile', () => {
      const userAgent =
        'Mozilla/5.0 (compatible; MSIE 10.0; Windows Phone 8.0;Trident/6.0; IEMobile/10.0; ARM; Touch; NOKIA; Lumia 920)';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.IEMOBILE);
    });

    it('should recognize WebOS', () => {
      const userAgent =
        'Mozilla/5.0 (webOS/1.3; U; en-US) AppleWebKit/525.27.1 (KHTML, like Gecko) Version/1.0 Safari/525.27.1 Desktop/1.0';
      expect(_getBrowserName(userAgent)).toBe(BrowserName.WEBOS);
    });

    it('should recognize an unlisted browser', () => {
      const userAgent =
        'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Awesome/2.0.012';
      expect(_getBrowserName(userAgent)).toBe('Awesome');
    });
    ...
    it('should default to Other', () => {
      ...
      expect(_getBrowserName(userAgent)).toBe(BrowserName.OTHER);
    });
  });
  ...
  describe('_isIOS', () => {
    it('should recognize iPhone', () => {
      ...
      expect(_isIOS(userAgent)).toBe(true);
    });
    ...
    it('should respond false for other mobile', () => {
      ...
      expect(_isIOS(userAgent)).toBe(false);
    });
  });
});
