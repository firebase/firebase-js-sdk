        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, sendPasswordResetEmail$1(authInternal, request).catch(function (error) { return __awaiter(_this, void 0, void 0, function () {
                            var requestWithRecaptcha;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, sendSignInLinkToEmail$1(authInternal, request).catch(function (error) { return __awaiter(_this, void 0, void 0, function () {
                            var requestWithRecaptcha;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
...
export { signInWithEmailLink as $, ActionCodeOperation as A, FacebookAuthProvider as B, GithubAuthProvider as C, OAuthProvider as D, EmailAuthCredential as E, FactorId as F, GoogleAuthProvider as G, SAMLAuthProvider as H, signInAnonymously as I, signInWithCredential as J, linkWithCredential as K, reauthenticateWithCredential as L, signInWithCustomToken as M, sendPasswordResetEmail as N, OperationType as O, ProviderId as P, confirmPasswordReset as Q, applyActionCode as R, SignInMethod as S, TwitterAuthProvider as T, checkActionCode as U, verifyPasswordResetCode as V, createUserWithEmailAndPassword as W, signInWithEmailAndPassword as X, sendSignInLinkToEmail as Y, isSignInWithEmailLink as Z, _signInWithRedirect as _, _reauthenticateWithRedirect as a, reauthenticateWithRedirect as a$, fetchSignInMethodsForEmail as a0, sendEmailVerification as a1, verifyBeforeUpdateEmail as a2, ActionCodeURL as a3, parseActionCodeURL as a4, updateProfile as a5, updateEmail as a6, updatePassword as a7, getIdToken as a8, getIdTokenResult as a9, _withDefaultResolver as aA, FederatedAuthProvider as aB, _fail as aC, _getProjectConfig as aD, _getCurrentUrl as aE, _emulatorUrl as aF, _isChromeIOS as aG, _isFirefox as aH, _isIOSStandalone as aI, _isMobileBrowser as aJ, _isSafari as aK, _isIOS as aL, _getRedirectResult as aM, _getRedirectUrl as aN, _setWindowLocation as aO, AuthEventManager as aP, debugFail as aQ, finalizeEnrollPhoneMfa as aR, _persistenceKeyName as aS, UserImpl as aT, _getInstance as aU, AuthImpl as aV, _getClientVersion as aW, FetchProvider as aX, SAMLAuthCredential as aY, signInWithRedirect as aZ, linkWithRedirect as a_, unlink as aa, getAdditionalUserInfo as ab, reload as ac, getMultiFactorResolver as ad, multiFactor as ae, _performApiRequest as af, _addTidIfNecessary as ag, _assert as ah, Delay as ai, _window as aj, isV2 as ak, _createError as al, _loadJS as am, _generateCallbackName as an, getRecaptchaParams as ao, _isHttpOrHttps as ap, _isWorker as aq, _castAuth as ar, sendPhoneVerificationCode as as, startEnrollPhoneMfa as at, _assertLinkedStatus as au, _link$1 as av, debugAssert as aw, _generateEventId as ax, AbstractPopupRedirectOperation as ay, _assertInstanceOf as az, _linkWithRedirect as b, indexedDBLocalPersistence as c, cordovaPopupRedirectResolver as d, browserLocalPersistence as e, browserSessionPersistence as f, getRedirectResult as g, setRecaptchaConfig as h, initializeAuth as i, onAuthStateChanged as j, updateCurrentUser as k, signOut as l, deleteUser as m, debugErrorMap as n, onIdTokenChanged as o, prodErrorMap as p, AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY as q, registerAuth as r, setPersistence as s, connectAuthEmulator as t, useDeviceLanguage as u, AuthCredential as v, OAuthCredential as w, PhoneAuthCredential as x, inMemoryPersistence as y, EmailAuthProvider as z };
//# sourceMappingURL=popup_redirect-4275be26.js.map
