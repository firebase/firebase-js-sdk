                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [2 /*return*/, FetchProvider.fetch()(_getFinalTarget(auth, 'staging-identitytoolkit.sandbox.googleapis.com', path, query), __assign({ method: method,
