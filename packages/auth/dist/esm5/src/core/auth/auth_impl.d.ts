...
import { Auth, AuthErrorMap, AuthSettings, EmulatorConfig, RecaptchaConfig, NextOrObserver, Persistence, PopupRedirectResolver, User, CompleteFn, ErrorFn, Unsubscribe } from '../../model/public_types';
