 ...
 */
export function fromRef<T>(ref: database.Query, event: ListenEvent, listenType = 'on'): Observable<SnapshotPrevKey> {
...
export const unwrap = () => map((payload: SnapshotPrevKey) =>  {
