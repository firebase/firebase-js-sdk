...
import { storageInstanceKey } from './util';
...
export function ref(storage: StorageNext, path?: string): ReferenceNext {
    ...
    const ref = new ReferenceImplNext(storageInternal);
    if (path != null) {
...
export function put(ref: ReferenceNext, data: Blob | Uint8Array | ArrayBuffer, metadata?: UploadMetadata): UploadTask {
