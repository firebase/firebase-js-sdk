 ...
 *
 * See {@link https://github.com/firebase/firebase-js-sdk/blob/ch-branchswitch-main/packages/firebase/index.d.ts|interface documentation} for method descriptions.
 */
