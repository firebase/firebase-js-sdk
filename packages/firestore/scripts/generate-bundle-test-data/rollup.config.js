...
export default [
  {
    input: 'generate-bundle-test-data.ts',
    output: {
      file: 'dist/generate-bundle-test-data.em2017.js',
      format: 'es',
      sourcemap: true
    },
  ...
  {
    input: 'dist/generate-bundle-test-data.em2017.js',
    output: [
      {
        file: 'dist/generate-bundle-test-data.cjs.js',
        format: 'cjs',
        sourcemap: true
      }
    ],
