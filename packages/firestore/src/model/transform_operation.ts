...
import { Value as PublicValue } from '../protos/firestore_proto_api';
...
export function applyTransformOperationToLocalView(
  ...
  previousValue: PublicValue | null,
...
export function applyTransformOperationToRemoteDocument(
  transform: TransformOperation,
  previousValue: PublicValue | null,
  transformResult: PublicValue | null
): PublicValue {
...
export class ArrayUnionTransformOperation extends TransformOperation {
  constructor(readonly elements: PublicValue[]) {
    super();
  }
}
...
function asNumber(value: PublicValue): number {
  return normalizeNumber(value.integerValue || value.doubleValue);
}

function coercedFieldValuesArray(value: PublicValue | null): PublicValue[] {
