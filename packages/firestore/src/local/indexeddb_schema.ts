 ...
 */
export class DbDocumentChanges {
  /** Name of the IndexedDb object store.  */
  static store = 'documentChanges';

  /** Keys are auto-generated via the `autoGeneratedKey` property. */
  static keyPath = 'autoGeneratedKey';

  constructor(
    public autoGeneratedKey: number | undefined,
    /**
...
/*
 * The key for DbDocumentChanges, consisting of an auto-incrementing number.
*/
export type DbDocumentChangeSKey = number;

function createDocumentChangesStore(db: IDBDatabase): void {
  db.createObjectStore(DbDocumentChanges.store, {
    keyPath: 'autoGeneratedKey',
    autoIncrement: true
  });
}
