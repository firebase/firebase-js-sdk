...
export class WriteBatch {
  ...
  set<AppType, DbType extends DocumentData>(
    documentRef: DocumentReference<AppType, DbType>,
    data: WithFieldValue<AppType> | PartialWithFieldValue<AppType>,
    options?: SetOptions
  ): WriteBatch {
...
export function validateReference<AppType, DbType extends DocumentData>(
  documentRef:
    | DocumentReference<AppType, DbType>
    | Compat<DocumentReference<AppType, DbType>>,
  firestore: Firestore
): DocumentReference<AppType, DbType> {
  ...
  if (documentRef.firestore !== firestore) {
    ...
    return documentRef as DocumentReference<AppType, DbType>;
  }
}
