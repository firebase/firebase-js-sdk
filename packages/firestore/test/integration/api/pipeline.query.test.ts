...
(USE_EMULATOR ? apiPipelineDescribe : apiPipelineDescribe.skip)(
  'Queries',
    ...
    it('key order is descending for descending inequality', () => {
      ...
      return withTestCollection(persistence, testDocs, coll => {
        return getDocs(
          ...
          expect(results(docs).map(d => d.id)).toEqual([
            'g',
            'f',
            'c',
            'b',
      ...
      it('can use or queries with array membership', () => {
        ...
        return withTestCollection(persistence, testDocs, async coll => {
          ...
          await checkOnlineAndOfflineResultsMatchWithPipelineMode(
            ...
            query(
              coll,
              or(where('a', '==', 2), where('b', 'array-contains', 7))
            ),
            'doc3',
            'doc4',
            'doc6'
