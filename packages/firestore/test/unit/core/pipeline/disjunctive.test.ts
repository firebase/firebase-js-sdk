...
describe('Disjunctive Queries', () => {
  ...
  it('or_isNullAndEqOnSameField', () => {
    ...
    const pipeline = db
      .pipeline()
      .collection('/users')
      .where(or(equal(field('a'), constant(1)), isNull(field('a'))));
  ...
  it('or_isNullAndEqOnDifferentField', () => {
    ...
    const pipeline = db
      .pipeline()
      .collection('/users')
      .where(or(equal(field('b'), constant(1)), isNull(field('a'))));
  ...
  it('or_isNotNullAndEqOnSameField', () => {
    ...
    const pipeline = db
      .pipeline()
      .collection('/users')
      .where(or(greaterThan(field('a'), constant(1)), not(isNull(field('a')))));
  ...
  it('or_isNotNullAndEqOnDifferentField', () => {
    ...
    const pipeline = db
      .pipeline()
      .collection('/users')
      .where(or(equal(field('b'), constant(1)), not(isNull(field('a')))));
