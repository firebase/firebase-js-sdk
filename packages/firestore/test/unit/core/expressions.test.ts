...
function expectEqual(
  ...
  return expect(
    valueEquals(evaluated!, expected._getValue(), {nanEqual: true, mixIntegerDouble: true, semanticsEqual: true}),
...
describe('Arithmetic Expressions', () => {
  describe('add', () => {
    ...
    it.skip('longAddition_overflow', () => {
      expect(evaluate(add(Constant.of(0x7fffffffffffffff), Constant.of(1)))).to
        .be.undefined;
      expect(evaluate(add(Constant.of(0x8000000000000000), Constant.of(-1)))).to
        .be.undefined;
      expect(evaluate(add(Constant.of(1), Constant.of(0x7fffffffffffffff)))).to
        .be.undefined;
    });
  ...
  describe('mod', () => {
    it('divisorZero_throwsError', () => {
      ...
      expect(
        evaluate(mod(Constant.of(42), Constant.of(0.0)))
      ).to.be.undefined;
      expect(
        evaluate(mod(Constant.of(42), Constant.of(-0.0)))
      ).to.be.undefined;
