...
describe('Md5', () => {
  ...
  it('constructor should create distinct instances', () => {
    ...
    expect(instance1).toBeInstanceOf(Md5);
    expect(instance2).toBeInstanceOf(Md5);
  ...
  it('update() should accept a string', () => {
    const md5 = new Md5();
    md5.update('abc');
    expect(md5.digest()).toEqual(DIGEST_OF_ABC);
  });

  it('update() should accept a string of non-standard characters', () => {
    const md5 = new Md5();
    md5.update('ÀÒ∑');
    expect(md5.digest()).toEqual(DIGEST_OF_SPECIAL_CHARACTERS);
  });
  ...
  it('update() should accept a string of UTF-8 encoded non-standard characters ', () => {
    ...
    expect(md5.digest()).toEqual(DIGEST_OF_SPECIAL_CHARACTERS_ENCODED);
  });
  ...
  it('reset() should reset', () => {
    ...
    md5.reset();
    md5.update('def');
    expect(md5.digest()).toEqual(DIGEST_OF_DEF);
  });
});
...
describe('Integer', () => {
  it('constructor should create distinct instances', () => {
    ...
    expect(instance1).toBeInstanceOf(Integer);
    expect(instance2).toBeInstanceOf(Integer);
    expect(instance1).not.toBe(instance2);
  });

  it('constructor should construct 1 and -1, 2 and -2', () => {
    const positiveOne = new Integer([1], 0);
    expect(positiveOne.toNumber()).toBe(1);
    const negativeOne = new Integer([-1], -1);
    expect(negativeOne.toNumber()).toBe(-1);
    const positiveTwo = new Integer([2], 0);
    expect(positiveTwo.toNumber()).toBe(2);
    const negativeTwo = new Integer([-2], -1);
    expect(negativeTwo.toNumber()).toBe(-2);
  });

  it('constructor should construct big positive values', () => {
    expect(new Integer([0xff], 0).toNumber()).toBe(255);
    expect(new Integer([0xffff], 0).toNumber()).toBe(65535);
    expect(new Integer([0xffffff], 0).toNumber()).toBe(16777215);
    expect(new Integer([0xffffffff], 0).toNumber()).toBe(4294967295);
    expect(new Integer([0, 1], 0).toNumber()).toBe(4294967296);
    expect(new Integer([1, 1], 0).toNumber()).toBe(4294967297);
    expect(new Integer([0xfffffffe, 1], 0).toNumber()).toBe(8589934590);
    expect(new Integer([0xffffffff, 1], 0).toNumber()).toBe(8589934591);
    expect(new Integer([0, 2], 0).toNumber()).toBe(8589934592);
    expect(new Integer([1, 2], 0).toNumber()).toBe(8589934593);
    expect(
      new Integer(
        [0x992ce530, 0xbc1f3bbb, 0x2080e2ee, 0xe53c0595],
        0
      ).toString()
    ).toBe('304704862073361391914321619654827369776');
  });

  it('constructor should construct big negative values', () => {
    expect(new Integer([0xffffffff], -1).toNumber()).toBe(-1);
    expect(new Integer([0xfffffffe], -1).toNumber()).toBe(-2);
    expect(new Integer([0xfffffffd], -1).toNumber()).toBe(-3);
    expect(new Integer([0xfffffff0], -1).toNumber()).toBe(-16);
    expect(new Integer([0xffffff00], -1).toNumber()).toBe(-256);
    expect(new Integer([0xfffff000], -1).toNumber()).toBe(-4096);
    expect(new Integer([0xffff0000], -1).toNumber()).toBe(-65536);
    expect(new Integer([0xfff00000], -1).toNumber()).toBe(-1048576);
    expect(new Integer([0xff000000], -1).toNumber()).toBe(-16777216);
    expect(new Integer([0xf0000000], -1).toNumber()).toBe(-268435456);
    expect(new Integer([0x00000001], -1).toNumber()).toBe(-4294967295);
    expect(new Integer([0x00000000], -1).toNumber()).toBe(-4294967296);
    expect(new Integer([0x00000000, 0xffffffff], -1).toNumber()).toBe(
      -4294967296
    );
    expect(new Integer([0xffffffff, 0xfffffffe], -1).toNumber()).toBe(
      -4294967297
    );
    expect(new Integer([0xfffffffe, 0xfffffffe], -1).toNumber()).toBe(
      -4294967298
    );
  });

  it('add() should produce the sum of the two numbers', () => {
    expect(Integer.fromNumber(0).add(Integer.fromNumber(0)).toNumber()).toBe(0);
    expect(Integer.fromNumber(1).add(Integer.fromNumber(1)).toNumber()).toBe(2);
    expect(
    ...
    expect(
      Integer.fromString('304704862073361391914321619654827369776')
        ...
        .toString()
    ).toBe('382098109640305444064095430472135313281');
    expect(Integer.fromNumber(0).add(Integer.fromNumber(-1)).toNumber()).toBe(
      -1
    );
  });
  ...
  it('modulo() should produce the division remainder of the two numbers', () => {
    expect(() => Integer.fromNumber(0).modulo(Integer.fromNumber(0))).toThrow(
      'division by zero'
    );
    expect(() => Integer.fromNumber(42).modulo(Integer.fromNumber(0))).toThrow(
      'division by zero'
    );
    expect(
      Integer.fromNumber(20).modulo(Integer.fromNumber(1)).toNumber()
    ).toBe(0);
    expect(Integer.fromNumber(2).modulo(Integer.fromNumber(2)).toNumber()).toBe(
      0
    );
    expect(Integer.fromNumber(3).modulo(Integer.fromNumber(2)).toNumber()).toBe(
      1
    );
    expect(Integer.fromNumber(4).modulo(Integer.fromNumber(2)).toNumber()).toBe(
      0
    );
    expect(
      Integer.fromNumber(0xffffffff)
    ...
    expect(
      Integer.fromString('304704862073361391914321619654827369776')
        ...
        .toString()
    ).toBe('72525119372529235465000187202903539261');
    expect(
      Integer.fromString('304704862073361391914321619654827369776')
  ...
  it('compare() should correctly compare two numbers for order', () => {
    ...
    for (let i1 = 0; i1 < numbers.length; i1++) {
      for (let i2 = 0; i2 < numbers.length; i2++) {
        ...
        expect(num1.compare(num2)).toBe(expected);
      }
    }
  });
  ...
  it('toNumber() should return the correct number', () => {
    ...
    expect(Integer.fromNumber(0).toNumber()).toBe(0);
    expect(Integer.fromNumber(1).toNumber()).toBe(1);
    expect(Integer.fromNumber(-1).toNumber()).toBe(-1);
    expect(Integer.fromNumber(Number.MAX_SAFE_INTEGER).toNumber()).toBe(
      Number.MAX_SAFE_INTEGER
    );
    expect(Integer.fromNumber(Number.MIN_SAFE_INTEGER).toNumber()).toBe(
  ...
  it('toString() should return the correct number', () => {
    const one = Integer.fromNumber(1);
    const two = Integer.fromNumber(2);
    expect(Integer.fromNumber(0).toString()).toBe('0');
    expect(Integer.fromNumber(1).toString()).toBe('1');
    expect(Integer.fromNumber(-1).toString()).toBe('-1');
    expect(Integer.fromNumber(Number.MAX_SAFE_INTEGER).toString()).toBe(
      '9007199254740991'
    );
    expect(Integer.fromNumber(Number.MIN_SAFE_INTEGER).toString()).toBe(
      '-9007199254740991'
    );
    expect(
    ...
    expect(Integer.fromNumber(0).toString(2)).toBe('0');
    expect(Integer.fromNumber(43981).toString(2)).toBe('1010101111001101');
    expect(Integer.fromNumber(43981).toString(8)).toBe('125715');
    expect(Integer.fromNumber(43981).toString(10)).toBe('43981');
    expect(Integer.fromNumber(43981).toString(16)).toBe('abcd');
  });
  ...
  it('fromString() create a new Integer with the given value', () => {
    expect(Integer.fromString('0').toNumber()).toBe(0);
    expect(Integer.fromString('1').toNumber()).toBe(1);
    expect(Integer.fromString('-1').toNumber()).toBe(-1);
    expect(Integer.fromString('42').toNumber()).toBe(42);
    expect(Integer.fromString('9007199254740991').toNumber()).toBe(
      Number.MAX_SAFE_INTEGER
    );
    expect(Integer.fromString('-9007199254740991').toNumber()).toBe(
      Number.MIN_SAFE_INTEGER
    ...
    expect(Integer.fromString('abcd', 16).toNumber()).toBe(43981);
    expect(Integer.fromString('125715', 8).toNumber()).toBe(43981);
    expect(Integer.fromString('1010101111001101', 2).toNumber()).toBe(43981);
  });

  it('getBits() create a new Integer with the given value', () => {
    expect(new Integer([1, 2], 0).getBits(0)).toBe(1);
    expect(new Integer([1, 2], 0).getBits(1)).toBe(2);
    expect(new Integer([-1, -2], -1).getBits(0)).toBe(-1);
    expect(new Integer([-1, -2], -1).getBits(1)).toBe(-2);
    expect(new Integer([0xff, 0xffff], 0).getBits(0)).toBe(0xff);
    expect(new Integer([0xff, 0xffff], 0).getBits(1)).toBe(0xffff);
  });
});
