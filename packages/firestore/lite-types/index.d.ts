...
export declare function collection(firestore: FirebaseFirestore, path: string, ...pathComponents: string[]): CollectionReference<DocumentData>;
export declare function collection(reference: CollectionReference<unknown>, path: string, ...pathComponents: string[]): CollectionReference<DocumentData>;
export declare function collection(reference: DocumentReference, path: string, ...pathComponents: string[]): CollectionReference<DocumentData>;
...
export declare function doc(firestore: FirebaseFirestore, path: string, ...pathComponents: string[]): DocumentReference<DocumentData>;
export declare function doc<T>(reference: CollectionReference<T>, path?: string, ...pathComponents: string[]): DocumentReference<T>;
export declare function doc(reference: DocumentReference<unknown>, path: string, ...pathComponents: string[]): DocumentReference<DocumentData>;
...
export declare class QueryDocumentSnapshot<T = DocumentData> {
    data(): T;
    exists(): boolean;
    data(fieldPath: string | FieldPath): any;
}
