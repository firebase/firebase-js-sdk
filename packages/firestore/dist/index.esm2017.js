...
/** A dot-separated path for navigating sub-objects within a document. */ class W extends q {
    ...
    F() {
        return this.N().map(t => (t = t.replace("\\", "\\\\").replace("`", "\\`"), W.M(t) || (t = "`" + t + "`"), 
        t)).join(".");
    }
    toString() {
        return this.F();
...
class ht {
    ...
    nt(t, e) {
        return new ht(this.P, this.root.nt(t, e, this.P).copy(null, null, ct.st, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new ht(this.P, this.root.remove(t, this.P).copy(null, null, ct.st, null, null));
    }
 ...
 */ class Pt {
    ...
    constructor(t) {
        ...
        this.Ft = Tt(), this.kt = new ht(this.P);
    }
    /**
...
class Ct {
     ...
     */    Fe(t) {
        ...
        this.Ie.forEach((n, s) => {
            ...
            if (i) {
                if (n.Ht && Z(i.target)) {
                    ...
                    null !== this.me.get(e) || this.ke(s, e) || this.ge(s, e, new mn(e, t));
                }
        ...
        return this.me = ft(), this.Ae = Nt(), this.Re = new ut(b), s;
    }
    /**
    ...
    xe(t) {
        let e = this.Ae.get(t);
        return e || (e = new ut(b), this.Ae = this.Ae.nt(t, e)), e;
    }
    /**
 ...
 */ (o);
        ...
        }), h = new In(i, r, o, {}), a = s.targetIds || [], c = s.removedTargetIds || [];
...
function ye(t) {
    ...
    let c = null;
    return n.endAt && (c = ve(n.endAt)), bn(Vn(e, i, o, r, h, "F" /* First */ , a, c));
}
...
function Ne(t) {
    switch (t.unaryFilter.op) {
      ...
      case "IS_NOT_NAN":
        ...
        return $n.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = De(t.unaryFilter.field);
        return $n.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function pn(t) {
    ...
    if (null === e.nn) {
        ...
        t.O() || e.nn.push(new Yn(t)), e.nn.push(new Yn(W.L(), "asc" /* ASCENDING */)); else {
            let t = !1;
...
class $n extends class {} {
     ...
     */    static create(t, e, n) {
        if (t.O()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.fn(t, e, n) : new On(t, e, n);
        if (Yt(n)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new M($.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new $n(t, e, n);
        }
        if (Jt(n)) {
            if ("==" /* EQUAL */ !== e && "!=" /* NOT_EQUAL */ !== e) 
            // TODO(ne-queries): Update error message to include != comparison.
            throw new M($.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new $n(t, e, n);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Un(t, n) : "in" /* IN */ === e ? new Wn(t, n) : "not-in" /* NOT_IN */ === e ? new Qn(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new jn(t, n) : new $n(t, e, n);
    }
    static fn(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.dn(qt(e, this.value)) : null !== e && Mt(this.value) === Mt(e) && this.dn(qt(e, this.value));
...
/** Filter that matches on key fields not present within an array. */ class qn extends $n {
    constructor(t, e) {
...
function Bn(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map(t => Q.B(t.referenceValue));
}

/** A Filter that implements the array-contains operator. */ class Un extends $n {
    constructor(t, e) {
...
/** A Filter that implements the IN operator. */ class Wn extends $n {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class Qn extends $n {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class jn extends $n {
    constructor(t, e) {
...
class Zn {
     ...
     */    In(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = en(n, e, e, this.wn));
        const n = e;
        // Second, apply all user-provided mutations.
                for (const s of this.mutations) s.key.isEqual(t) && (e = en(s, e, n, this.wn));
        return e;
    }
    /**
 ...
 */ class es {
    ...
    next(t, e) {
        return this.yn && P(), this.yn = !0, this.gn ? this.error ? this.pn(e, this.error) : this.bn(t, this.result) : new es((n, s) => {
            this.Pn = e => {
    ...
    bn(t, e) {
        return t ? this.Sn(() => t(e)) : es.resolve(e);
    }
    pn(t, e) {
        return t ? this.Sn(() => t(e)) : es.reject(e);
    }
    static resolve(t) {
        return new es((e, n) => {
            e(t);
 ...
 */ class ns {
    constructor() {
        ...
        this.Nn = new x(t => t.toString(), (t, e) => t.isEqual(e)), this.Fn = !1;
    }
    set readTime(t) {
        this.kn = t;
    }
     ...
     */    On(t, e) {
        ...
        return void 0 !== n ? es.resolve(n) : this.Ln(t, e);
    }
    /**
 ...
 */
        return function(t) {
            return Q.W(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.ns(t, e.path) : yn(e) ? this.ss(t, e, n) : this.rs(t, e, n);
    }
    ns(t, e) {
        // Just do a simple document lookup.
        return this.zn(t, new Q(e)).next(t => {
            let e = Tt();
    ...
    ss(t, e, n) {
        ...
        let i = Tt();
        return this.Gn.os(t, s).next(r => es.forEach(r, r => {
    ...
    rs(t, e, n) {
        ...
        this.as(t, i, s).next(t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = en(e, i, i, t.wn);
...
class cs {
     ...
     */    ps(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && I("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Ps} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class us {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === us.Ns(s()) && m("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return I("SimpleDb", "Removing database:", t), Ts(window.indexedDB.deleteDatabase(t)).vn();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Fs() {
        ...
        // Check the UA string to find out the browser.
                const t = s(), e = us.Ns(t), n = 0 < e && e < 10, i = us.xs(t), r = 0 < i && i < 4.5;
        // IE 10
     ...
     */    async Os() {
        return this.db || (I("SimpleDb", "Opening database:", this.name), this.db = await new Promise((t, e) => {
            ...
            n.onsuccess = e => {
                ...
                e(new _s("Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, n.onerror = t => {
                const n = t.target.error;
                "VersionError" === n.name ? e(new M($.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : e(new _s(n));
            }, n.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n) {
        ...
        for (;;) {
            ...
            try {
                ...
                const t = ds.open(this.db, s ? "readonly" : "readwrite", e), i = n(t).catch(e => (
                // Abort the transaction if there was an error.
                t.abort(e), es.reject(e))).vn();
 ...
 */ class ls {
     ...
     */    delete() {
        return Ts(this.Us.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class _s extends M {
    constructor(t) {
 ...
 */ class ds {
    constructor(t) {
         ...
         */
        this.Gs = new as, this.transaction.oncomplete = () => {
            this.Gs.resolve();
        }, this.transaction.onabort = () => {
            t.error ? this.Gs.reject(new _s(t.error)) : this.Gs.resolve();
        }, this.transaction.onerror = t => {
            const e = Is(t.target.error);
            this.Gs.reject(new _s(e));
        };
    }
    static open(t, e, n) {
        try {
            return new ds(t.transaction(n, e));
        } catch (t) {
            throw new _s(t);
        }
    }
    ...
    abort(t) {
        t && this.Gs.reject(t), this.aborted || (I("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function ms() {
...
class Rs {
    constructor(t, e, n, s, i) {
        this.ti = t, this.Is = e, this.ei = n, this.op = s, this.ni = i, this.si = new as, 
     ...
     */    cancel(t) {
        null !== this.ri && (this.clearTimeout(), this.si.reject(new M($.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    oi() {
...
class Ps {
    constructor() {
        ...
        this.wi = new cs(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ti = () => {
            const t = As();
            t && I("AsyncQueue", "Visibility state changed to  ", t.visibilityState), this.wi.Ss();
        };
        const t = As();
 ...
 */ (t)), t;
     ...
     */    vs(t, e, n) {
        ...
        const s = Rs.ii(this, t, e, n, t => this.gi(t));
 ...
 */ function Vs(t, e) {
    if (m("AsyncQueue", `${e}: ${t}`), fs(t)) return new M($.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class ys {
    constructor(t) {
        this.Di = t, this.buffer = new ut(gs), this.Ci = 0;
    }
    Ni() {
        return ++this.Ci;
    }
    Fi(t) {
        ...
        if (this.buffer.size < this.Di) this.buffer = this.buffer.add(e); else {
            ...
            gs(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
...
class bs {
    ...
    static Bi(t) {
        return new bs(t, bs.Ui, bs.Wi);
    }
}

bs.Qi = -1, bs.ji = 1048576, bs.Ki = 41943040, bs.Ui = 10, bs.Wi = 1e3, bs.Gi = new bs(bs.Ki, bs.Ui, bs.Wi), 
bs.zi = new bs(bs.Qi, 0, 0);
...
class vs {
    ...
    start(t) {
        this.Hi.params.Oi !== bs.Qi && this.Xi(t);
    }
    stop() {
    ...
    Xi(t) {
        ...
        I("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Ji = this.ti.vs("lru_garbage_collection" /* LruGarbageCollection */ , e, async () => {
            this.Ji = null, this.Yi = !0;
            try {
                await t.tr(this.Hi);
            } catch (t) {
                fs(t) ? I("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Mi(t);
            }
            await this.Xi(t);
        });
    }
...
/** Implements the steps for LRU garbage collection. */ class Ss {
    constructor(t, e) {
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */    ir(t, e) {
        if (0 === e) return es.resolve(hs.Ts);
        const n = new ys(e);
    ...
    ar(t, e) {
        return this.params.Oi === bs.Qi ? (I("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        es.resolve(ps)) : this.cr(t).next(n => n < this.params.Oi ? (I("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ` + this.params.Oi), 
        ps) : this.ur(t, e));
    }
    cr(t) {
        return this.er.cr(t);
    ...
    ur(t, e) {
        ...
        e > this.params.qi ? (I("LruGarbageCollector", `Capping sequence numbers to collect down to the maximum of ${this.params.qi} from ` + e), 
        i = this.params.qi) : i = e, o = Date.now(), this.ir(t, i))).next(n => (s = n, h = Date.now(), 
        this.or(t, s, e))).next(e => (r = e, a = Date.now(), this.hr(t, s))).next(t => {
            if (c = Date.now(), E() <= n.DEBUG) {
...
function Ds(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = Ns(e)), e = Cs(t.get(n), e);
    return Ns(e);
}
 ...
 */ function Fs(t) {
    ...
    const e = t.length;
    if (V(e >= 2), 2 === e) return V("" === t.charAt(0) && "" === t.charAt(1)), B.$();
...
/** Decodes a remote document from storage locally to a Document. */ function xs(t, e) {
    ...
    if (e.noDocument) {
        const t = Q.j(e.noDocument.path), n = qs(e.noDocument.readTime);
        return new mn(t, n, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        const t = Q.j(e.unknownDocument.path), n = qs(e.unknownDocument.version);
        return new An(t, n);
    }
    return P();
}
...
/** Encodes a document for storage locally. */ function $s(t, e, n) {
    ...
    if (e instanceof mn) {
        const t = e.key.path.N(), n = Ls(e.version), r = e.hasCommittedMutations;
        return new li(
        /* unknownDocument= */ null, new ci(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e instanceof An) {
        const t = e.key.path.N(), n = Ls(e.version);
        return new li(new ui(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function Bs(t, e) {
    const n = (e.baseMutations || []).map(e => Re(t.lr, e)), s = e.mutations.map(e => Re(t.lr, e)), i = O.fromMillis(e.localWriteTimeMs);
    return new Zn(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Us(t) {
    const e = qs(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? qs(t.lastLimboFreeSnapshotVersion) : L.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (V(1 === (i = t.query).documents.length), 
    s = bn(gn(de(i.documents[0])))) : s = ye(t.query), new et(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, tt.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function Ws(t, e) {
    const n = Ls(e.X), s = Ls(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Z(e.target) ? Ve(t.lr, e.target) : ge(t.lr, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new fi(e.targetId, Y(e.target), n, r, e.sequenceNumber, s, i);
}
...
class Qs {
    ...
    Ir(t, e, n, s) {
        ...
        return r.add({}).next(o => {
            ...
            const h = new Zn(o, e, n, s), a = function(t, e, n) {
                const s = n.baseMutations.map(e => Ae(t.lr, e)), i = n.mutations.map(e => Ae(t.lr, e));
                return new hi(e, n.batchId, n.wn.toMillis(), s, i);
            }(this.serializer, this.userId, h), c = [];
            let u = new ut((t, e) => b(t.F(), e.F()));
            for (const t of s) {
                const e = ai.key(this.userId, t.key.path, o);
                u = u.add(t.key.path.p()), c.push(r.put(a)), c.push(i.put(e, ai.PLACEHOLDER));
            }
            return u.forEach(e => {
    ...
    Ar(t, e) {
        return Gs(t).get(e).next(t => t ? (V(t.userId === this.userId), Bs(this.serializer, t)) : null);
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Rr(t, e) {
        return this.dr[e] ? es.resolve(this.dr[e]) : this.Ar(t, e).next(t => {
            if (t) {
                const n = t.keys();
    ...
    Pr(t, e) {
        ...
        return Gs(t).Xs({
            ...
            e.userId === this.userId && (V(e.batchId >= n), i = Bs(this.serializer, e)), s.done();
        }).next(() => i);
    }
    Vr(t) {
    ...
    gr(t) {
        ...
        return Gs(t).zs(hi.userMutationsIndex, e).next(t => t.map(t => Bs(this.serializer, t)));
    }
    Hn(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = ai.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return zs(t).Xs({
            range: s
        }, (n, s, r) => {
            const [o, h, a] = n, c = Fs(h);
            ...
            return Gs(t).get(a).next(t => {
                if (!t) throw P();
                V(t.userId === this.userId), i.push(Bs(this.serializer, t));
            });
            r.done();
        }).next(() => i);
    }
    ts(t, e) {
        ...
        const s = [];
        return e.forEach(e => {
            const i = ai.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = zs(t).Xs({
                range: r
            }, (t, s, i) => {
            ...
            s.push(o);
        }), es.Dn(s).next(() => this.yr(t, n));
    }
    hs(t, e) {
        const n = e.path, s = n.length + 1, i = ai.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    yr(t, e) {
        ...
        return e.forEach(e => {
            s.push(Gs(t).get(e).next(t => {
                if (null === t) throw P();
                V(t.userId === this.userId), n.push(Bs(this.serializer, t));
            }));
        }), es.Dn(s).next(() => n);
    }
    pr(t, e) {
        return Ks(t.br, this.userId, e).next(n => (t.Wn(() => {
            this.vr(e.batchId);
        }), es.forEach(n, e => this._r.Sr(t, e))));
    }
    /**
    ...
    Dr(t) {
        return this.Er(t).next(e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(ai.prefixForUser(this.userId)), s = [];
            return zs(t).Xs({
                range: n
            }, (t, e, n) => {
                if (t[0] === this.userId) {
    ...
    Nr(t) {
        return Hs(t).get(this.userId).next(t => t || new oi(this.userId, -1, 
        /*lastStreamToken=*/ ""));
    }
}
 ...
 */ function js(t, e, n) {
    const s = ai.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return zs(t).Xs({
        range: r,
        Js: !0
 ...
 */
function Ks(t, e, n) {
    const s = t.store(hi.store), i = t.store(ai.store), r = [], o = IDBKeyRange.only(n.batchId);
    let h = 0;
    const a = s.Xs({
        range: o
    }, (t, e, n) => (h++, n.delete()));
    ...
    for (const t of n.mutations) {
        const s = ai.key(e, t.key.path, n.batchId);
        r.push(i.delete(s)), c.push(t.key);
    }
    return es.Dn(r).next(() => c);
}

/**
 * Helper to get a typed SimpleDbStore for the mutations object store.
 */ function Gs(t) {
    return Si.Ms(t, hi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function zs(t) {
    return Si.Ms(t, ai.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Hs(t) {
    return Si.Ms(t, oi.store);
}
 ...
 */ class Ys {
    ...
    On(t, e) {
        return Xs(t).get(Zs(e)).next(t => this.kr(t));
    }
    /**
     ...
     */    Or(t, e) {
        ...
        return this.Mr(t, e, (t, e) => {
            const i = this.kr(e);
            i ? (n = n.nt(t, i), s = s.nt(t, ti(e))) : (n = n.nt(t, null), s = s.nt(t, 0));
        }).next(() => ({
            Lr: n,
            qr: s
        }));
    ...
    es(t, e, n) {
        ...
        if (n.isEqual(L.min())) {
            ...
            const t = e.path.N(), s = Ms(n);
            r.range = IDBKeyRange.lowerBound([ t, s ], 
            /* open= */ !0), r.index = li.collectionReadTimeIndex;
        }
        return Xs(t).Xs(r, (t, n, r) => {
    ...
    Br(t, e) {
        let n = ft(), s = Ms(e);
        const i = Xs(t), r = IDBKeyRange.lowerBound(s, !0);
        return i.Xs({
            index: li.readTimeIndex,
            range: r
        }, (t, e) => {
            // Unlike `getEntry()` and others, `getNewDocumentChanges()` parses
            // the documents directly since we want to keep sentinel deletes.
            const i = xs(this.serializer, e);
    ...
    Wr(t) {
        ...
        return e.Xs({
            ...
            e.readTime && (n = Os(e.readTime)), s.done();
        }).next(() => n);
    }
    Qr(t) {
        return new Ys.jr(this, !!t && t.Kr);
    }
    Gr(t) {
        return this.getMetadata(t).next(t => t.byteSize);
    }
    getMetadata(t) {
        return Js(t).get(_i.key).next(t => (V(!!t), t));
    }
    Fr(t, e) {
        return Js(t).put(_i.key, e);
    }
    /**
 ...
 */ function Js(t) {
    return Si.Ms(t, _i.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Xs(t) {
    return Si.Ms(t, li.store);
}
 ...
 */ Ys.jr = class extends ns {
    ...
    constructor(t, e) {
        ...
        this.Hr = new x(t => t.toString(), (t, e) => t.isEqual(e));
    }
    Bn(t) {
        const e = [];
        let n = 0, s = new ut((t, e) => b(t.F(), e.F()));
        return this.Nn.forEach((i, r) => {
            const o = this.Hr.get(i);
            if (r) {
                const h = $s(this.zr.serializer, r, this.readTime);
                s = s.add(i.path.p());
                const a = ti(h);
                ...
                const n = $s(this.zr.serializer, new mn(i, L.min()), this.readTime);
                e.push(this.zr.xn(t, i, n));
            } else e.push(this.zr.Mn(t, i));
        }), s.forEach(n => {
            e.push(this.zr.Gn.mr(t, n));
        }), e.push(this.zr.updateMetadata(t, n)), es.Dn(e);
    }
    Ln(t, e) {
...
class ei {
    ...
    mr(t, e) {
        return this.Yr.add(e), es.resolve();
    }
    os(t, e) {
        return es.resolve(this.Yr.getEntries(e));
    }
}
 ...
 */ class ni {
    ...
    add(t) {
        const e = t.S(), n = t.p(), s = this.index[e] || new ut(B.P), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ut(B.P)).N();
    }
}
 ...
 */ (t));
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(di.store), t.deleteObjectStore(fi.store), t.deleteObjectStore(wi.store);
        }(t), Ei(t)), r = r.next(() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(wi.store), n = new wi(
            /*highestTargetId=*/ 0, 
 ...
 */ (i))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next(() => function(t, e) {
            return e.store(hi.store).zs().next(n => {
                t.deleteObjectStore(hi.store);
                t.createObjectStore(hi.store, {
                    keyPath: hi.keyPath,
                    autoIncrement: !0
                }).createIndex(hi.userMutationsIndex, hi.userMutationsKeyPath, {
                ...
                const s = e.store(hi.store), i = n.map(t => s.put(t));
                return es.Dn(i);
            });
        }
        /**
 ...
 */ (t), this.addDocumentGlobal(i)))), n < 7 && s >= 7 && (r = r.next(() => this.ensureSequenceNumbers(i))), 
        n < 8 && s >= 8 && (r = r.next(() => this.createCollectionParentIndex(t, i))), n < 9 && s >= 9 && (r = r.next(() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(li.store);
                e.createIndex(li.readTimeIndex, li.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(li.collectionReadTimeIndex, li.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }
            /**
 ...
 */ (e);
    ...
    addDocumentGlobal(t) {
        let e = 0;
        return t.store(li.store).Xs((t, n) => {
            e += ti(n);
        }).next(() => {
            const n = new _i(e);
            return t.store(_i.store).put(_i.key, n);
        });
    }
    removeAcknowledgedMutations(t) {
        const e = t.store(oi.store), n = t.store(hi.store);
        return e.zs().next(e => es.forEach(e, e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.zs(hi.userMutationsIndex, s).next(n => es.forEach(n, n => {
                V(n.userId === e.userId);
                const s = Bs(this.serializer, n);
     ...
     */    ensureSequenceNumbers(t) {
        const e = t.store(di.store), n = t.store(li.store);
        return t.store(wi.store).get(wi.key).next(t => {
            const s = [];
            return n.Xs((n, i) => {
 ...
 */ (r);
                s.push(e.get(o).next(n => n ? es.resolve() : (n => e.put(new di(0, Ds(n), t.highestListenSequenceNumber)))(r)));
            }).next(() => es.Dn(s));
        });
    }
    createCollectionParentIndex(t, e) {
        ...
        const n = e.store(Ti.store), s = new ni, i = t => {
            if (s.add(t)) {
                const e = t.S(), s = t.p();
                return n.put({
                    collectionId: e,
        ...
        return e.store(li.store).Xs({
            Js: !0
        }, (t, e) => {
            const n = new B(t);
            return i(n.p());
        }).next(() => e.store(ai.store).Xs({
            Js: !0
        }, ([t, e, n], s) => {
            const r = Fs(e);
            return i(r.p());
    ...
    rewriteCanonicalIds(t) {
        ...
        return e.Xs((t, n) => {
            const s = Us(n), i = Ws(this.serializer, s);
            return e.put(i);
        });
    }
}
...
/** Name of the IndexedDb object store.  */ oi.store = "mutationQueues", 
 ...
 */
li.readTimeIndex = "readTimeIndex", li.readTimeIndexPath = "readTime", 
/**
 ...
 */
li.collectionReadTimeIndex = "collectionReadTimeIndex", li.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
_i.store = "remoteDocumentGlobal", _i.key = "remoteDocumentGlobalKey";
...
/** Name of the IndexedDb object store.  */ di.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
di.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
di.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
di.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ function Ei(t) {
    t.createObjectStore(di.store, {
        keyPath: di.keyPath
    }).createIndex(di.documentTargetsIndex, di.documentTargetsKeyPath, {
        unique: !0
    });
...
/** Name of the IndexedDb object store. */ Ii.store = "clientMetadata", 
/** Keys are automatically assigned via the clientId properties. */
Ii.keyPath = "clientId";

const mi = [ ...[ ...[ ...[ oi.store, hi.store, ai.store, li.store, fi.store, ri.store, wi.store, di.store ], Ii.store ], _i.store ], Ti.store ];
 ...
 */ class Vi {
    ...
    io(t) {
        return this.no(t).next(t => L.I(new O(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds)));
    }
    ro(t) {
    ...
    lo(t, e) {
        return this._o(t, e.targetId).next(() => gi(t).delete(e.targetId)).next(() => this.no(t)).next(e => (V(e.targetCount > 0), 
    ...
    no(t) {
        return yi(t).get(wi.key).next(t => (V(null !== t), t));
    }
    so(t, e) {
        return yi(t).put(wi.key, e);
    }
    ao(t, e) {
        return gi(t).put(Ws(this.serializer, e));
    }
    /**
    ...
    wo(t, e, n) {
        ...
        return e.forEach(e => {
            const r = Ds(e.path);
            s.push(i.put(new di(n, r))), s.push(this._r.To(t, n, e));
        }), es.Dn(s);
    }
    Eo(t, e, n) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        ...
        return es.forEach(e, e => {
            const i = Ds(e.path);
            return es.Dn([ s.delete([ n, i ]), this._r.Io(t, n, e) ]);
        });
    }
    _o(t, e) {
    ...
    mo(t, e) {
        ...
        return s.Xs({
            ...
            const s = Fs(t[1]), r = new Q(s);
            i = i.add(r);
        }).next(() => i);
    }
    Cr(t, e) {
        const n = Ds(e.path), s = IDBKeyRange.bound([ n ], [ S(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return pi(t).Xs({
            index: di.documentTargetsIndex,
            Js: !0,
            range: s
        }, ([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    Me(t, e) {
        return gi(t).get(e).next(t => t ? Us(t) : null);
    }
}
 ...
 */ function gi(t) {
    return Si.Ms(t, fi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function yi(t) {
    return Si.Ms(t, wi.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function pi(t) {
    return Si.Ms(t, di.store);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const bi = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
 ...
 */ class Si {
    ...
    c) {
        ...
        this.Do = t => Promise.resolve(), !Si.Fs()) throw new M($.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this._r = new Ni(this, s), this.Co = e + "main", this.serializer = new ks(h), this.No = new us(this.Co, 10, new si(this.serializer)), 
        this.Fo = new Vi(this._r, this.serializer), this.Gn = new Ai, this.jn = new Ys(this.serializer, this.Gn), 
        this.window && this.window.localStorage ? this.ko = this.window.localStorage : (this.ko = null, 
        !1 === c && m("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
    }
    static Ms(t, e) {
        if (t instanceof vi) return us.Ms(t.br, e);
        throw P();
    }
    /**
     ...
     * primary lease.
     */    xo() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", t => Ci(t).put(new Ii(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next(() => {
    ...
    Uo(t) {
        return Di(t).get(ri.key).next(t => es.resolve(this.Ko(t)));
    }
    Go(t) {
     ...
     */    Wo(t) {
        if (this.Po) return es.resolve(!0);
        return Di(t).get(ri.key).next(e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Ci(t).zs().next(t => void 0 === this.Yo(t, 5e3).find(t => {
    ...
    async Zo() {
        ...
        await this.No.runTransaction("readwrite", [ ri.store, Ii.store ], t => {
            const e = new vi(t, hs.Ts);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    ih() {
        return this.runTransaction("getActiveClients", "readonly", t => Ci(t).zs().next(t => this.Yo(t, 18e5).map(t => t.clientId)));
    }
    get Zi() {
        return this.yo;
    }
    rh(t) {
        return Qs.wr(t, this.serializer, this.Gn, this._r);
    }
    oh() {
        return this.Fo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.No.runTransaction(s, mi, s => (i = new vi(s, this.Vo ? this.Vo.next() : hs.Ts), 
        "readwrite-primary" === e ? this.Uo(i).next(t => !!t || this.Wo(i)).next(e => {
            ...
            this.Es.Pi(() => this.Do(!1)), new M($.FAILED_PRECONDITION, ss);
            return n(i);
    ...
    // be turned off.
    uh(t) {
        return Di(t).get(ri.key).next(t => {
            if (null !== t && this.Ho(t.leaseTimestampMs, 5e3) && !this.Xo(t.ownerId) && !this.Ko(t) && !(this.Po || this.allowTabSynchronization && t.allowTabSynchronization)) throw new M($.FAILED_PRECONDITION, bi);
        });
    }
    /**
     ...
     */    jo(t) {
        const e = new ri(this.clientId, this.allowTabSynchronization, Date.now());
        return Di(t).put(ri.key, e);
    }
    static Fs() {
        return us.Fs();
    }
    /** Checks the primary lease and removes it if we are the current primary. */    Qo(t) {
        const e = Di(t);
        return e.get(ri.key).next(t => this.Ko(t) ? (I("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(ri.key)) : es.resolve());
    }
 ...
 */ function Di(t) {
    return Si.Ms(t, ri.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Ci(t) {
    return Si.Ms(t, Ii.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ class Ni {
    constructor(t, e) {
        this.db = t, this.Hi = new Ss(this, e);
    }
    sr(t) {
        const e = this.lh(t);
     ...
     */    fh(t, e) {
        return function(t, e) {
            let n = !1;
            return Hs(t).Zs(s => js(t, s, e).next(t => (t && (n = !0), es.resolve(!t)))).next(() => n);
        }(t, e);
    }
    hr(t, e) {
        ...
        return this._h(t, (r, o) => {
            if (o <= e) {
                const e = this.fh(t, r).next(e => {
                    ...
                    // removing them.
                    return i++, n.On(t, r).next(() => (n.Mn(r), pi(t).delete([ 0, Ds(r.path) ])));
                });
                s.push(e);
            }
        }).next(() => es.Dn(s)).next(() => n.apply(t)).next(() => i);
    }
    removeTarget(t, e) {
        const n = e.Z(t.Ao);
...
class xi {
    ...
    t, e, n) {
        ...
        this.Eh = new x(t => Y(t), X), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Ih = L.min(), this.Kn = t.rh(n), this.mh = t.hh(), this.Fo = t.oh(), this.Ah = new rs(this.mh, this.Kn, this.persistence.ah()), 
        this.wh.Rh(this.Ah);
    }
    async Ph(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new rs(this.mh, e, this.persistence.ah()), e.gr(s))).next(t => {
                const e = [], r = [];
    ...
    Sh(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.Kn.Ar(e, t).next(t => (V(null !== t), n = t.keys(), this.Kn.pr(e, t))).next(() => this.Kn.Dr(e)).next(() => this.Ah.Xn(e, n));
        });
    }
    Vr() {
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Wt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    xi.Ch(o, a, t) && r.push(this.Fo.uo(s, a));
                }
            });
            let o = ft(), h = mt();
            ...
            r.push(i.getEntries(s, h).next(n => {
                t.jt.forEach((h, a) => {
                    ...
                    o = o.nt(h, a)) : I("LocalStore", "Ignoring outdated watch update for ", h, ". Current version:", c.version, " Watch version:", a.version), 
            ...
            return es.Dn(r).next(() => i.apply(s)).next(() => this.Ah.Zn(s, o));
        }).then(t => (this.Th = n, t));
    }
    /**
    ...
    async Fh(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => es.forEach(t, t => es.forEach(t.cs, n => this.persistence._r.To(e, t.targetId, n)).next(() => es.forEach(t.us, n => this.persistence._r.Io(e, t.targetId, n)))));
        } catch (t) {
            if (!fs(t)) throw t;
    ...
    $h(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, es.resolve(n)) : this.Fo.eo(e).next(s => (n = new et(t, s, 0 /* Listen */ , e.Ao), 
    ...
    do(t, e) {
        ...
        return void 0 !== n ? es.resolve(this.Th.get(n)) : this.Fo.do(t, e);
    }
    async Mh(t, e) {
    ...
    Oh(t, e) {
        let n = L.min(), s = mt();
        return this.persistence.runTransaction("Execute query", "readonly", i => this.do(i, bn(t)).next(t => {
            if (t) return n = t.lastLimboFreeSnapshotVersion, this.Fo.mo(i, t.targetId).next(t => {
                s = t;
            });
        }).next(() => this.wh.es(i, t, e ? n : L.min(), e ? s : mt())).next(t => ({
            documents: t,
            Lh: s
        })));
    }
...
// PORTING NOTE: Multi-Tab only.
function $i(t, e) {
    const n = g(t), s = g(n.Fo), i = n.Th.get(e);
 ...
 */
async function Mi(t) {
    if (t.code !== $.FAILED_PRECONDITION || t.message !== ss) throw t;
...
class Oi {
    constructor() {
        ...
        this.qh = new ut(Li.Bh), 
        // A set of outstanding references to a document sorted by target id.
        this.Uh = new ut(Li.Wh);
    }
     ...
     * removed.
     */    Gh(t) {
        const e = new Q(new B([])), n = new Li(e, t), s = new Li(e, t + 1), i = [];
    ...
    Hh(t) {
        const e = new Q(new B([])), n = new Li(e, t), s = new Li(e, t + 1);
        let i = mt();
        return this.Uh.vt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    Cr(t) {
        const e = new Li(t, 0), n = this.qh.Dt(e);
...
class Li {
    ...
    /** Compare by key then by ID */    static Bh(t, e) {
        return Q.P(t.key, e.key) || b(t.Yh, e.Yh);
    }
    /** Compare by ID then by key */    static Wh(t, e) {
        return b(t.Yh, e.Yh) || Q.P(t.key, e.key);
    }
}
...
qi.Xh = new qi("google-credentials-uid"), qi.Zh = new qi("first-party-uid");
...
class Wi {
    constructor(t) {
        ...
        this.currentUser = qi.UNAUTHENTICATED, this.oa = !1, 
        /**
    ...
    getToken() {
        ...
        this.ha !== t ? (I("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (V("string" == typeof e.accessToken), new Bi(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
    }
    na() {
        this.forceRefresh = !0;
    }
    ...
    aa() {
        ...
        return V(null === t || "string" == typeof t), new qi(t);
    }
}
 ...
 */ class Qi {
    constructor(t, e) {
        this.ca = t, this.ua = e, this.type = "FirstParty", this.user = qi.Zh;
    }
    get ta() {
        const t = {
 ...
 */ class ji {
    ...
    getToken() {
        return Promise.resolve(new Qi(this.ca, this.ua));
    }
    sa(t) {
...
class Ki {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.wa = 0, this.Ta = null, this.stream = null, this.wi = new cs(t, e);
    }
    /**
     ...
     */    ba(t) {
        return e => {
            this.Es.hi(() => this.wa === t ? e() : (I("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class Gi extends Ki {
     ...
     */    xa(t) {
        const e = {};
        e.database = we(this.serializer), e.removeTarget = t, this.Va(e);
    }
}
 ...
 */ class zi extends Ki {
    ...
    onMessage(t) {
        ...
        V(!!t.streamToken), this.lastStreamToken = t.streamToken, this.$a) {
        ...
        return V(!t.writeResults || 0 === t.writeResults.length), this.$a = !0, this.listener.qa();
    }
    /**
     ...
     */    Ba() {
        ...
        const t = {};
        t.database = we(this.serializer), this.Va(t);
    }
...
class Hi extends class {} {
    ...
    Wa() {
        if (this.Ua) throw new M($.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    Qa(t, e, n) {
        return this.Wa(), this.credentials.getToken().then(s => this.fa.Qa(t, e, n, s)).catch(t => {
            throw t.code === $.UNAUTHENTICATED && this.credentials.na(), t;
        });
    }
...
class Yi {
    ...
    Xa(t) {
        ...
        this.Ha ? (m(e), this.Ha = !1) : I("OnlineStateTracker", e);
    }
    tc() {
    ...
    e, n, s, i) {
        ...
        this.oc = new Set, this.hc = i, this.hc.ac(t => {
            n.hi(async () => {
                ...
                // down our streams.
                this.cc() && (I("RemoteStore", "Restarting streams for network reachability change."), 
                await this.uc());
            });
        }), this.lc = new Yi(n, s), 
        ...
        this._c = function(t, e, n) {
            const s = g(t);
            return s.Wa(), new Gi(e, s.fa, s.credentials, s.serializer, n);
        }
        /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (this.nc, n, {
            ...
            const s = g(t);
            return s.Wa(), new zi(e, s.fa, s.credentials, s.serializer, n);
        }(this.nc, n, {
    ...
    async gc() {
        await this.Tc.stop(), await this._c.stop(), this.sc.length > 0 && (I("RemoteStore", `Stopping write stream with ${this.sc.length} pending writes`), 
        this.sc = []), this.yc();
    }
    async Zo() {
        I("RemoteStore", "RemoteStore shutting down."), this.oc.add(5 /* Shutdown */), await this.gc(), 
        this.hc.Zo(), 
    ...
    Pc() {
        this.rc = new Ct(this), this._c.start(), this.lc.Ya();
    }
    /**
    ...
    async wc(t, e) {
        ...
        this.lc.set("Online" /* Online */), t instanceof St && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.Cc(e);
        } else if (t instanceof bt ? this.rc.Pe(t) : t instanceof vt ? this.rc.De(t) : this.rc.ye(t), 
        !e.isEqual(L.min())) try {
            ...
            I("RemoteStore", "Failed to raise snapshot:", t), await this.Cc(t);
        }
    }
    /**
     ...
     */    async Cc(t, e) {
        ...
        this.ti.Pi(async () => {
            I("RemoteStore", "Retrying IndexedDB access"), await e(), this.oc.delete(1 /* IndexedDbFailed */), 
            await this.Ac();
        });
    }
    /**
    ...
    async La(t, e) {
        const n = this.sc.shift(), s = ts.from(n, t, e);
 ...
 */    }
    ...
    async Wc(t) {
        ...
        I("RemoteStore", "RemoteStore received new credentials"), this.oc.add(3 /* CredentialChange */), 
...
class er {
     ...
     */    static jc(t, e, n) {
        ...
        i && (r = new M(s.error.code, s.error.message))), i ? new er(t, e, s.state, r) : (m("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Kc() {
        const t = {
...
class nr {
     ...
     */    static jc(t, e) {
        ...
        s && (i = new M(n.error.code, n.error.message))), s ? new nr(t, n.state, i) : (m("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Kc() {
        const t = {
 ...
 */ class sr {
     ...
     */    static jc(t, e) {
        ...
        return s ? new sr(t, i) : (m("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class ir {
     ...
     */    static jc(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new ir(e.clientId, e.onlineState) : (m("SharedClientState", "Failed to parse online state: " + t), 
        null);
    }
}
 ...
 */ class or {
    constructor(t, e, n, s, i) {
        ...
        this.Ka = null, this._s = null, this.Yc = this.Jc.bind(this), this.Xc = new ht(b), 
        this.Zi = !1, 
        /**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Xc = this.Xc.nt(this.Hc, new rr), this.nu = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    Jc(t) {
        ...
        if (e.storageArea === this.storage) {
            if (I("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.tu) return void m("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Es.Pi(async () => {
                if (this.Zi) {
...
class hr {
    constructor() {
        this.xu = new rr, this.$u = {}, this.Ka = null, this._s = null;
    }
    _u(t) {
        // No op.
    }
    ...
    start() {
        return this.xu = new rr, Promise.resolve();
    }
    Ph(t, e, n) {
        // No op.
    }
 ...
 */ class ur {
    ...
    e) {
        ...
        this.Lt = mt(), this.qu = xn(t), this.Bu = new Pt(this.qu);
    }
    /**
     ...
     */    Wu(t, e) {
        const n = e ? e.Qu : new Vt, s = e ? e.Bu : this.Bu;
        ...
        if (t.ot((t, e) => {
            const c = s.get(t);
            let u = e instanceof In ? e : null;
            u && (u = kn(this.query, u) ? u : null);
 ...
 */ (t.type, e.type) || this.qu(t.doc, e.doc)), this.Gu(n);
        ...
        if (this.Ou = o, 0 !== i.length || h) {
            return {
                snapshot: new gt(this.query, t.Bu, s, i, t.Lt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                Hu: r
            };
        }
    ...
    zu() {
        ...
        // updating many documents.
                const t = this.Lu;
        this.Lu = mt(), this.Bu.forEach(t => {
            this.Ju(t.key) && (this.Lu = this.Lu.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Lu.has(t) || e.push(new cr(t));
        }), this.Lu.forEach(n => {
    ...
    // PORTING NOTE: Multi-tab only.
    Zu() {
        return gt.Ut(this.query, this.Bu, this.Lt, 0 /* Local */ === this.Ou);
    }
}
 ...
 */ class fr {
    ...
    s, i, r) {
        ...
        this.il = null, this.rl = new x(t => Nn(t), Cn), this.ol = new Map, 
        /**
        ...
        this._l = new Map, this.fl = Pi.to(), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async listen(t) {
        ...
        e = s.targetId, this.nl.Tu(e), n = s.view.Zu(); else {
            const s = await this.ec.$h(bn(t)), i = this.nl.Tu(s.targetId);
     ...
     */    async El(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new ur(t, s.Lh), r = i.Wu(s.documents), o = pt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Bn(r, 
    ...
    async bc(t) {
        ...
        // to the target.
                if (n.length > 1) return this.ol.set(e.targetId, n.filter(e => !Cn(e, t))), 
    ...
    async write(t, e) {
        ...
        try {
            ...
            const n = Vs(t, "Failed to persist write");
            e.reject(n);
        }
    }
    async Dh(t) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                V(t.Yt.size + t.Jt.size + t.Xt.size <= 1), t.Yt.size > 0 ? n.tl = !0 : t.Jt.size > 0 ? V(n.tl) : t.Xt.size > 0 && (V(n.tl), 
                n.tl = !1));
            }), await this.Rl(e, t);
        } catch (t) {
            await Mi(t);
    ...
    async kc(t, e) {
        ...
        } else await this.ec.Mh(t, /* keepPersistedTargetData */ !1).then(() => this.ml(t, e)).catch(Mi);
    }
    async qc(t) {
    ...
    async pl(t) {
        this.el.cc() || I("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
            ...
            const n = Vs(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(n);
        }
    }
    /**
    ...
    Al(t, e) {
        ...
        n || (n = new ht(b)), n = n.nt(t, e), this.ll[this.currentUser.Jh()] = n;
    }
    /**
    ...
    Il(t, e) {
        for (const n of e) if (n instanceof ar) this.ul.To(n.key, t), this.Dl(n); else if (n instanceof cr) {
            I("SyncEngine", "Document no longer in limbo: " + n.key), this.ul.Io(n.key, t);
            this.ul.Cr(n.key) || 
            // We removed the last reference for this key
            this.Sl(n.key);
        } else P();
    ...
    Dl(t) {
        const e = t.key;
        this.al.get(e) || (I("SyncEngine", "New document in limbo: " + e), this.hl.push(e), 
        this.Vl());
    }
    /**
     ...
     */    Vl() {
        for (;this.hl.length > 0 && this.al.size < this.sl; ) {
            ...
            this.cl.set(e, new _r(t)), this.al = this.al.nt(t, e), this.el.listen(new et(bn(gn(t.path)), e, 2 /* LimboResolution */ , hs.Ts));
        }
    }
    // Visible for testing
    Cl() {
        ...
        this.rl.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                ...
                if (this.Il(o.targetId, r.Hu), r.snapshot) {
                    ...
                    n.push(r.snapshot);
                    const t = os.ls(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
    ...
    async Wc(t) {
        if (!this.currentUser.isEqual(t)) {
            I("SyncEngine", "User change. New user:", t.Jh());
...
async function dr(t, e) {
    const n = g(t), s = await n.ec.Oh(e.query, 
...
async function wr(t, e, n, s) {
    ...
    // PORTING NOTE: Multi-Tab only.
    function(t, e) {
        const n = g(t), s = g(n.Kn);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", t => s.Rr(t, e).next(e => e ? n.Ah.Xn(t, e) : es.resolve(null)));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.ec, e);
    null !== r ? ("pending" === n ? 
...
async function Tr(t, e) {
    ...
    if (!0 === e && !0 !== n.dl) {
        ...
        const t = n.nl.cu(), e = await Er(n, t.N());
...
async function Er(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await s.ec.$h(bn(n[0]));
            for (const t of n) {
                const e = s.rl.get(t), n = await dr(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await $i(s.ec, t);
            e = await s.ec.$h(n), await s.El(Ir(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
function mr(t) {
    const e = g(t);
    return g(g(e.ec).persistence).ih();
}
...
async function Ar(t, e, n, s) {
    ...
    I("SyncEngine", "Ignoring unexpected query state notification."); else if (i.ol.has(e)) switch (n) {
      case "current":
      case "not-current":
        {
            const t = await function(t) {
                const e = g(t), n = g(e.mh);
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Rr(t, e, n) {
    ...
    if (s.dl) {
        for (const t of e) {
            ...
            const e = await $i(s.ec, t), n = await s.ec.$h(e);
            await s.El(Ir(e), n.targetId, 
 ...
 */ class Vr {
    constructor(t) {
        this.Sc = t, this.xl = new x(t => Nn(t), Cn), this.onlineState = "Unknown" /* Unknown */ , 
    ...
    async listen(t) {
        ...
        if (s || (n = !0, s = new Pr), n) try {
            ...
            const n = Vs(e, `Initialization of query '${Fn(t.query)}' failed`);
 ...
 */ class gr {
     ...
     */    Ml(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new gt(t.query, t.docs, t.Ot, e, t.Lt, t.fromCache, t.qt, 
    ...
    Kl(t) {
        t = gt.Ut(t.query, t.docs, t.Lt, t.fromCache), this.Ul = !0, this.Bl.next(t);
    }
}
 ...
 */ class yr {
    ...
    es(t, e, s, i) {
        ...
        return e.on() || s.isEqual(L.min()) ? this.Hl(t, e) : this.zl.Xn(t, i).next(r => {
            const o = this.Yl(e, r);
            return (e.hn() || e.an()) && this.Ku(e.en, o, i, s) ? this.Hl(t, e) : (E() <= n.DEBUG && I("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), Fn(e)), 
    ...
    Hl(t, e) {
        return E() <= n.DEBUG && I("IndexFreeQueryEngine", "Using full collection scan to execute query:", Fn(e)), 
        this.zl.es(t, e, L.min());
    }
}
 ...
 */ class pr {
    constructor(t, e) {
        ...
        this.Xl = new ut(Li.Bh);
    }
    Er(t) {
        return es.resolve(0 === this.Kn.length);
    }
    Ir(t, e, n, s) {
        const i = this.Jl;
        ...
        for (const e of s) this.Xl = this.Xl.add(new Li(e.key, i)), this.Gn.mr(t, e.key.path.p());
        return es.resolve(r);
    }
    Ar(t, e) {
        return es.resolve(this.Zl(e));
    }
    Pr(t, e) {
        const n = e + 1, s = this.t_(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return es.resolve(this.Kn.length > i ? this.Kn[i] : null);
    }
    Vr() {
        return es.resolve(0 === this.Kn.length ? -1 : this.Jl - 1);
    }
    gr(t) {
        return es.resolve(this.Kn.slice());
    }
    Hn(t, e) {
    ...
    pr(t, e) {
        V(0 === this.n_(e.batchId, "removed")), this.Kn.shift();
        let n = this.Xl;
    ...
    Cr(t, e) {
        const n = new Li(e, 0), s = this.Xl.Dt(n);
        return es.resolve(e.isEqual(s && s.key));
    }
    Dr(t) {
        return this.Kn.length, es.resolve();
    }
    /**
 ...
 */ class br {
    ...
    es(t, e, n) {
        ...
        // the documents we need to match the query against.
                const i = new Q(e.path.child("")), r = this.docs.ct(i);
        for (;r.wt(); ) {
...
class vr {
    constructor(t) {
         ...
         * IDs.
         */
        this.h_ = new Oi, this.targetCount = 0, this.a_ = Pi.Zr();
    }
    pe(t, e) {
        return this.r_.forEach((t, n) => e(n)), es.resolve();
    }
    io(t) {
        return es.resolve(this.lastRemoteSnapshotVersion);
    }
    ro(t) {
        return es.resolve(this.o_);
    }
    eo(t) {
        return this.highestTargetId = this.a_.next(), es.resolve(this.highestTargetId);
    }
    oo(t, e, n) {
    ...
    ao(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.a_ = new Pi(e), this.highestTargetId = e), t.sequenceNumber > this.o_ && (this.o_ = t.sequenceNumber);
    }
    ho(t, e) {
        return this.ao(e), this.targetCount += 1, es.resolve();
    }
    uo(t, e) {
        return this.ao(e), es.resolve();
    }
    lo(t, e) {
    ...
    wo(t, e, n) {
        return this.h_.Qh(e, n), es.resolve();
    }
    Eo(t, e, n) {
        this.h_.Kh(e, n);
    ...
    _o(t, e) {
        return this.h_.Gh(e), es.resolve();
    }
    mo(t, e) {
    ...
    Cr(t, e) {
        return es.resolve(this.h_.Cr(e));
    }
}
...
class Sr {
     ...
     */
    constructor(t) {
        this.c_ = {}, this.Vo = new hs(0), this.yo = !1, this.yo = !0, this._r = t(this), 
        this.Fo = new vr(this);
        this.Gn = new ei, this.jn = new br(this.Gn, t => this._r.u_(t));
    }
    start() {
    ...
    rh(t) {
        let e = this.c_[t.Jh()];
        return e || (e = new pr(this.Gn, this._r), this.c_[t.Jh()] = e), e;
    }
    oh() {
        return this.Fo;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new Dr(this.Vo.next());
        return this._r.l_(), n(s).next(t => this._r.__(s).next(() => t)).vn().then(t => (s.Qn(), 
        t));
    }
    f_(t, e) {
        return es.Cn(Object.values(this.c_).map(n => () => n.Cr(t, e)));
    }
}
...
class Cr {
    ...
    To(t, e, n) {
        return this.d_.To(n, e), this.E_.delete(n), es.resolve();
    }
    Io(t, e, n) {
        return this.d_.Io(n, e), this.E_.add(n), es.resolve();
    }
    Sr(t, e) {
        return this.E_.add(e), es.resolve();
    }
    removeTarget(t, e) {
    ...
    __(t) {
        ...
        return es.forEach(this.E_, n => this.I_(t, n).next(t => {
            t || e.Mn(n);
    ...
    I_(t, e) {
        return es.Cn([ () => es.resolve(this.d_.Cr(e)), () => this.persistence.oh().Cr(t, e), () => this.persistence.f_(t, e) ]);
    }
}
...
class {
    ...
    Qa(t, e, n, s) {
        ...
        const r = {};
        return this.C_(r, s), this.N_(t, i, r, n).then(t => (I("RestConnection", "Received: ", t), 
        t), e => {
 ...
 */ {
    ...
    Na(t, e) {
        const n = [ this.v_, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = f(), u = {
        ...
        this.C_(u.initMessageHeaders, e), 
        ...
        i() || r() || o() || h() || a() || c() || (u.httpHeadersOverwriteParam = "$httpHeaders");
        const l = n.join("");
        I("Connection", "Creating WebChannel: " + l, u);
        const _ = s.createWebChannel(l, u);
        ...
        // enough the code is exception free.
            ...
            T || (T = !0, I("Connection", "WebChannel transport closed"), E.y_());
        }), m(d.EventType.ERROR, t => {
            T || (T = !0, A("Connection", "WebChannel transport errored:", t), E.y_(new M($.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!T) {
                ...
                if (i) {
                    ...
                    T = !0, E.y_(new M(e, n)), _.close();
                } else I("Connection", "WebChannel received:", n), E.p_(n);
            }
        }), setTimeout(() => {
 ...
 */ class Lr {
    ...
    Q_(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new yr, s = t.j_, new xi(e, n, s);
        var e, n, s;
    }
    B_(t) {
        if (t.G_.K_) throw new M($.FAILED_PRECONDITION, Or);
        return new Sr(Cr.T_);
    }
    q_(t) {
        return new hr;
    ...
    clearPersistence(t, e) {
        throw new M($.FAILED_PRECONDITION, Or);
    }
}
 ...
 */ class qr extends Lr {
    ...
    W_(t) {
        ...
        return new vs(e, t.ti);
    }
    B_(t) {
        const e = ki(t.b_.s, t.b_.persistenceKey), n = Mr(t.b_.s);
        return new Si(t.G_.synchronizeTabs, e, t.clientId, bs.Bi(t.G_.cacheSizeBytes), t.ti, ms(), As(), n, this.nl, t.G_.Po);
    }
    q_(t) {
        return new hr;
    }
    clearPersistence(t, e) {
        return async function(t) {
            if (!us.Fs()) return Promise.resolve();
            const e = t + "main";
            await us.delete(e);
        }
        /**
 ...
 */ class Br extends qr {
    ...
    async initialize(t) {
        ...
        const e = this.z_.Sc;
        this.nl instanceof or && (this.nl.Sc = {
            Nu: wr.bind(null, e),
            Fu: Ar.bind(null, e),
            ku: Rr.bind(null, e),
            ih: mr.bind(null, e)
        ...
        await this.persistence.Lo(async t => {
            await Tr(this.z_.Sc, t), this.U_ && (t && !this.U_.Zi ? this.U_.start(this.ec) : t || this.U_.stop());
        });
    }
    q_(t) {
        if (t.G_.K_ && t.G_.synchronizeTabs) {
            const e = ms();
            if (!or.Fs(e)) throw new M($.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const n = ki(t.b_.s, t.b_.persistenceKey);
            return new or(e, t.ti, n, t.clientId, t.j_);
        }
        return new hr;
    }
}
 ...
 */ class Ur {
    ...
    Z_(t) {
        return new Vr(this.Sc);
    }
    H_(t) {
        const e = Mr(t.b_.s), n = (s = t.b_, new kr(s));
        var s;
    ...
    Y_(t) {
        return new Ji(this.ec, this.nc, t.ti, t => this.Sc.Yu(t, 0 /* RemoteStore */), xr.Fs() ? new xr : new $r);
    }
    J_(t) {
 ...
 */ function jr(t, e) {
    if (0 !== e.length) throw new M($.INVALID_ARGUMENT, `Function ${t}() does not support arguments, but was called with ` + uo(e.length, "argument") + ".");
}
 ...
 */ function Kr(t, e, n) {
    if (e.length !== n) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires ` + uo(n, "argument") + ", but was called with " + uo(e.length, "argument") + ".");
}
 ...
 */ function Gr(t, e, n) {
    if (e.length < n) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires at least ` + uo(n, "argument") + ", but was called with " + uo(e.length, "argument") + ".");
}
 ...
 */ function zr(t, e, n, s) {
    if (e.length < n || e.length > s) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + s + " arguments, but was called with " + uo(e.length, "argument") + ".");
}
...
function Zr(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires its ${e} option to be an array, but it was: ` + io(s));
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires all ${e} elements to be ${n}, but the value at index ${r} was: ` + io(s[r]));
    }(t, e, n, s, i);
}
 ...
 */ function eo(t, e, n, s) {
    if (!e.some(t => t === s)) throw new M($.INVALID_ARGUMENT, `Invalid value ${io(s)} provided to function ${t}() for its ${co(n)} argument. Acceptable values: ` + e.join(", "));
    return s;
}
...
function ro(t, e, n) {
    if (void 0 === n) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires a valid ${co(e)} argument, but it was undefined.`);
}
 ...
 */ function ho(t, e, n, s) {
    const i = io(s);
    return new M($.INVALID_ARGUMENT, `Function ${t}() requires its ${co(n)} argument to be a ${e}, but it was: ${i}`);
}

function ao(t, e, n) {
    if (n <= 0) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires its ${co(e)} argument to be a positive number, but it was: ${n}.`);
}

/** Converts a number to its english word representation */ function co(t) {
    switch (t) {
      case 1:
        return "first";
...
/** Helper function to assert Base64 functions are available at runtime. */ function _o() {
 ...
 */ class fo {
    ...
    static fromBase64String(t) {
        ...
        _o();
        try {
            return new fo(tt.fromBase64String(t));
        } catch (t) {
    ...
    static fromUint8Array(t) {
        ...
        return new fo(tt.fromUint8Array(t));
    }
    toBase64() {
        return Kr("Blob.toBase64", arguments, 0), _o(), this.nf.toBase64();
    }
    toUint8Array() {
        return Kr("Blob.toUint8Array", arguments, 0), lo(), this.nf.toUint8Array();
    }
    toString() {
 ...
 */ class wo {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new M($.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an array with at least ` + uo(s, "element") + ".");
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (Hr("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new M($.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.sf = new W(t);
    }
}
 ...
 */ class To extends wo {
    ...
    isEqual(t) {
        if (!(t instanceof To)) throw ho("isEqual", "FieldPath", 1, t);
...
class Po extends Io {
    ...
    hf(t) {
        const e = Ao(this, t, 
        /*array=*/ !0), n = this._f.map(t => Lo(t, e)), s = new qe(n);
...
class Vo extends Io {
    ...
    hf(t) {
        const e = Ao(this, t, 
        /*array=*/ !0), n = this._f.map(t => Lo(t, e)), s = new Ue(n);
        return new ze(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class go extends Io {
    ...
    hf(t) {
        const e = new Qe(t.serializer, ie(t.serializer, this.ff));
...
/** The public FieldValue class of the lite API. */ class yo extends Io {
    constructor() {
        super();
    }
    static delete() {
        return jr("FieldValue.delete", arguments), new po(new mo("FieldValue.delete"));
    }
    static serverTimestamp() {
        return jr("FieldValue.serverTimestamp", arguments), new po(new Ro("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Gr("FieldValue.arrayUnion", arguments, 1), new po(new Po("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Gr("FieldValue.arrayRemove", arguments, 1), new po(new Vo("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return Hr("FieldValue.increment", "number", 1, t), Kr("FieldValue.increment", arguments, 1), 
        new po(new go("FieldValue.increment", t));
    }
}
 ...
 */ class po extends yo {
    ...
    isEqual(t) {
        return t instanceof po && this.if.isEqual(t.if);
    }
}
 ...
 */ class bo {
     ...
     * with an underscore.
     */    T(t) {
        return b(this.df, t.df) || b(this.wf, t.wf);
    }
}
...
/** A "context" object passed around while parsing user data. */ class Fo {
    ...
    cf(t) {
        return jo(t, this.settings.methodName, this.settings.pf || !1, this.path, this.settings.uf);
    }
    ...
    Vf(t) {
        ...
        if (No(this.af) && vo.test(t)) throw this.cf('Document fields cannot begin and end with "__"');
    }
}
...
/** Parse document data from a set() call. */ function xo(t, e, n, s, i, r = {}) {
    const o = t.bf(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Uo("Data must be an object, but it was:", o, s);
    const h = qo(s, o);
    let a, c;
    if (r.merge) a = new Ge(o.Le), c = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof wo) i = s.sf; else {
        ...
        a = new Ge(t), c = o.fieldTransforms.filter(t => a.je(t.field));
    } else a = null, c = o.fieldTransforms;
    return new Do(new dn(h), a, c);
}
...
/** Parse update data from an update() call. */ function $o(t, e, n, s) {
    ...
    const r = [], o = new wn;
    F(s, (t, s) => {
        const h = Qo(e, t, n), a = i.gf(h);
        if (s instanceof Io && s.if instanceof mo) 
    ...
    const h = new Ge(r);
    return new Co(o.Ge(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Mo(t, e, n, s, i, r) {
    const o = t.bf(1 /* Update */ , e, n), h = [ Wo(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(Wo(e, r[t])), a.push(r[t + 1]);
    const c = [], u = new wn;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!Ko(c, h[t])) {
        const e = h[t], n = a[t], s = o.gf(e);
        if (n instanceof Io && n.if instanceof mo) 
        // Add it to the field mask, but don't add anything to updateData.
        c.push(e); else {
            const t = Lo(n, s);
    ...
    const l = new Ge(c);
    return new Co(u.Ge(), l, o.fieldTransforms);
}
 ...
 */ function Oo(t, e, n, s = !1) {
    return Lo(n, t.bf(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Lo(t, e) {
    if (Bo(t)) return Uo("Unsupported field value:", e, t), qo(t, e);
    if (t instanceof Io) 
 ...
 */
    return function(t, e) {
        ...
        if (!No(e.af)) throw e.cf(t.rf + "() can only be used with update() and set()");
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof So) {
            ...
            return {
                referenceValue: ce(t.Tf || e.s, t.Ef.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.cf("Unsupported field value: " + io(t));
    }
    /**
...
function qo(t, e) {
    ...
    e.path && e.path.length > 0 && e.Le.push(e.path) : F(t, (t, s) => {
        const i = Lo(s, e.Pf(t));
        null != i && (n[t] = i);
    }), {
        mapValue: {
...
function Bo(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof O || t instanceof bo || t instanceof fo || t instanceof So || t instanceof Io);
}
 ...
 */ function Wo(t, e, n) {
    if (e instanceof wo) return e.sf;
    if ("string" == typeof e) return Qo(t, e);
 ...
 */ function Qo(t, e, n) {
    try {
        return function(t) {
            if (t.search(Eo) >= 0) throw new M($.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`);
            try {
                return new To(...t.split("."));
            } catch (e) {
                throw new M($.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);
            }
        }(e).sf;
    } catch (e) {
        throw jo((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
 ...
 */ class Go {
    ...
    async Nf(t) {
        ...
        const e = await async function(t, e) {
            const n = g(t), s = we(n.serializer) + "/documents", i = {
        ...
        return e.forEach(t => {
            t instanceof mn || t instanceof In ? this.kf(t) : P();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new _n(t, this.Ue(t)) ]), this.Cf.add(t);
    }
    async commit() {
     ...
     */    Ue(t) {
        ...
        return !this.Cf.has(t) && e ? Je.updateTime(e) : Je.We();
    }
    /**
...
class zo {
    constructor(t, e, n, s) {
        this.ti = t, this.nc = e, this.updateFunction = n, this.si = s, this.$f = 5, this.wi = new cs(this.ti, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Of() {
        this.wi.ps(async () => {
            const t = new Go(this.nc), e = this.Lf(t);
            e && e.then(e => {
    ...
    Lf(t) {
        try {
            ...
            return !j(e) && e.catch && e.then ? e : (this.si.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
class Ho {
     ...
     */
    e) {
        this.credentials = t, this.ti = e, this.clientId = p.t(), 
     ...
     */    start(t, e, n, s) {
        ...
        return this.credentials.sa(t => {
            if (!r) return r = !0, I("FirestoreClient", "Initializing. user=", t.uid), this.Qf(e, n, s, t, i).then(this.Uf.resolve, this.Uf.reject);
     ...
     */    Wf() {
        if (this.ti.Ei) throw new M($.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    ...
    listen(t, e, n) {
        this.Wf();
        const s = new Qr(n), i = new gr(t, s, e);
        ...
        return this.Wf(), await this.Uf.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    ...
                    const e = Vs(t, `Failed to get document '${n} from cache`);
                    s.reject(e);
                }
            }), s.promise;
        }
 ...
 */ (this.ti, this.ec, t);
    ...
    async zf(t, e) {
        return this.Wf(), await this.Uf.promise, function(t, e, n, s) {
            const i = new as, r = Yo(t, e, gn(n.path), {
        ...
        return this.Wf(), await this.Uf.promise, async function(t, e, n) {
            ...
            return await t.enqueue(async () => {
                try {
                    ...
                    /* usePreviousResults= */ !0), i = new ur(n, t.Lh), r = i.Wu(t.documents), o = i.Bn(r, 
                    /* updateLimboDocuments= */ !1);
                    s.resolve(o.snapshot);
                } catch (t) {
                    const e = Vs(t, `Failed to execute query '${n} against cache`);
                    s.reject(e);
                }
            }), s.promise;
        }
 ...
 */ (this.ti, this.jf, t, e);
     ...
     */    transaction(t) {
        this.Wf();
        const e = new as;
        return this.ti.hi(() => (new zo(this.ti, this.nc, t, e).Mf(), Promise.resolve())), 
        e.promise;
    }
}

function Yo(t, e, n, s, i) {
    const r = new Qr(i), o = new gr(n, r, s);
...
class Jo {
    ...
    rd(t) {
        return new bo(jt(t.latitude), jt(t.longitude));
    }
    od(t) {
    ...
    sd(t) {
        const e = B.k(t);
        V(ke(e));
        const n = new C(e.get(1), e.get(3)), s = new Q(e.g(5));
...
class Zo {
    constructor(t) {
        ...
        Xr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = bs.Ki; else {
            if (t.cacheSizeBytes !== Xo && t.cacheSizeBytes < bs.ji) throw new M($.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + bs.ji);
 ...
 */ class th {
    ...
    constructor(t, e, n = new Lr, s = new Ur) {
        ...
        this._d = new Ps, this.INTERNAL = {
            ...
            const n = t;
            this.ld = n, this.Tf = th.wd(n), this.Td = n.name, this.Ed = new Wi(e);
        } else {
            const e = t;
            if (!e.projectId) throw new M($.INVALID_ARGUMENT, "Must provide projectId");
            this.Tf = new C(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Td = "[DEFAULT]", this.Ed = new Ui;
        }
        this.Id = new Zo({});
    }
    get md() {
        ...
        this.Ad = new ko(this.Tf, this.Id.ignoreUndefinedProperties)), this.Ad;
    }
    settings(t) {
        Kr("Firestore.settings", arguments, 1), Hr("Firestore.settings", "object", 1, t);
        const e = new Zo(t);
        if (this.dd && !this.Id.isEqual(e)) throw new M($.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.dd) throw new M($.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.dd && !this.dd.Jf) throw new M($.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new as;
    ...
    onSnapshotsInSync(t) {
        if (this.fd(), Wr(t)) return this.dd.Ll(t);
        {
    ...
    fd() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Pd(new Lr, new Ur, {
            K_: !1
        }), this.dd;
    }
    gd() {
        return new D(this.Tf, this.Td, this.Id.host, this.Id.ssl, this.Id.forceLongPolling);
    }
    Pd(t, e, n) {
        const s = this.gd();
        return this.dd = new Ho(this.Ed, this._d), this.dd.start(s, t, e, n);
    }
    static wd(t) {
 ...
 */        const s = t.options.projectId;
    ...
    get app() {
        if (!this.ld) throw new M($.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.ld;
    }
    collection(t) {
        return Kr("Firestore.collection", arguments, 1), Hr("Firestore.collection", "non-empty string", 1, t), 
        this.fd(), new wh(B.k(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Kr("Firestore.doc", arguments, 1), Hr("Firestore.doc", "non-empty string", 1, t), 
        this.fd(), sh.yd(B.k(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        ...
        return this.fd(), new fh(function(t) {
            return new Pn(B.$(), t);
        }(t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        ...
        this.fd().transaction(e => t(new eh(this, e)));
    }
    batch() {
        return this.fd(), new nh(this);
    }
    static get logLevel() {
        switch (E()) {
          case n.DEBUG:
 ...
 */ class eh {
    ...
    get(t) {
        ...
        const e = mh("Transaction.get", t, this.bd);
        return this.vd.Nf([ e.Ef ]).then(t => {
            if (!t || 1 !== t.length) return P();
            const n = t[0];
            if (n instanceof mn) return new rh(this.bd, e.Ef, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.If);
            if (n instanceof In) return new rh(this.bd, e.Ef, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.If);
            throw P();
        });
    ...
    set(t, e, n) {
        ...
        const s = mh("Transaction.set", t, this.bd);
        n = Th("Transaction.set", n);
        const i = Rh(s.If, e, n), r = xo(this.bd.md, "Transaction.set", s.Ef, i, null !== s.If, n);
        return this.vd.set(s.Ef, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof To ? (Gr("Transaction.update", arguments, 3), 
        i = mh("Transaction.update", t, this.bd), r = Mo(this.bd.md, "Transaction.update", i.Ef, e, n, s)) : (Kr("Transaction.update", arguments, 2), 
        i = mh("Transaction.update", t, this.bd), r = $o(this.bd.md, "Transaction.update", i.Ef, e)), 
        this.vd.update(i.Ef, r), this;
    }
    delete(t) {
        Kr("Transaction.delete", arguments, 1);
        const e = mh("Transaction.delete", t, this.bd);
...
class nh {
    ...
    set(t, e, n) {
        zr("WriteBatch.set", arguments, 2, 3), this.Cd();
        const s = mh("WriteBatch.set", t, this.bd);
        n = Th("WriteBatch.set", n);
        const i = Rh(s.If, e, n), r = xo(this.bd.md, "WriteBatch.set", s.Ef, i, null !== s.If, n);
        return this.Sd = this.Sd.concat(r.mf(s.Ef, Je.We())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.Cd(), "string" == typeof e || e instanceof To ? (Gr("WriteBatch.update", arguments, 3), 
        i = mh("WriteBatch.update", t, this.bd), r = Mo(this.bd.md, "WriteBatch.update", i.Ef, e, n, s)) : (Kr("WriteBatch.update", arguments, 2), 
        i = mh("WriteBatch.update", t, this.bd), r = $o(this.bd.md, "WriteBatch.update", i.Ef, e)), 
        this.Sd = this.Sd.concat(r.mf(i.Ef, Je.exists(!0))), this;
    }
    delete(t) {
        Kr("WriteBatch.delete", arguments, 1), this.Cd();
        const e = mh("WriteBatch.delete", t, this.bd);
        return this.Sd = this.Sd.concat(new _n(e.Ef, Je.We())), this;
    }
    commit() {
        return this.Cd(), this.Dd = !0, this.Sd.length > 0 ? this.bd.fd().write(this.Sd) : Promise.resolve();
    }
    Cd() {
        if (this.Dd) throw new M($.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class sh extends So {
    ...
    static yd(t, e, n) {
        if (t.length % 2 != 0) throw new M($.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t.F()} has ${t.length}`);
        return new sh(new Q(t), e, n);
    }
    get id() {
        return this.Ef.path.S();
    }
    get parent() {
        return new wh(this.Ef.path.p(), this.firestore, this.If);
    }
    get path() {
    ...
    collection(t) {
        ...
        const e = B.k(t);
        return new wh(this.Ef.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof sh)) throw ho("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Ef.isEqual(t.Ef) && this.If === t.If;
    }
    set(t, e) {
        zr("DocumentReference.set", arguments, 1, 2), e = Th("DocumentReference.set", e);
        const n = Rh(this.If, t, e), s = xo(this.firestore.md, "DocumentReference.set", this.Ef, n, null !== this.If, e);
        return this.dd.write(s.mf(this.Ef, Je.We()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof To ? (Gr("DocumentReference.update", arguments, 2), 
        s = Mo(this.firestore.md, "DocumentReference.update", this.Ef, t, e, n)) : (Kr("DocumentReference.update", arguments, 1), 
        s = $o(this.firestore.md, "DocumentReference.update", this.Ef, t)), this.dd.write(s.mf(this.Ef, Je.exists(!0)));
    }
    delete() {
        return Kr("DocumentReference.delete", arguments, 0), this.dd.write([ new _n(this.Ef, Je.We()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        ...
        return this.dd.listen(gn(this.Ef.path), o, h);
    }
    get(t) {
        zr("DocumentReference.get", arguments, 0, 1), Ih("DocumentReference.get", t);
        const e = this.firestore.fd();
        return t && "cache" === t.source ? e.Gf(this.Ef).then(t => new rh(this.firestore, this.Ef, t, 
        /*fromCache=*/ !0, t instanceof In && t.Ke, this.If)) : e.zf(this.Ef, t).then(t => this.Nd(t));
    }
    withConverter(t) {
        return new sh(this.Ef, this.firestore, t);
    }
    /**
     ...
     */    Nd(t) {
        ...
        return new rh(this.firestore, this.Ef, e, t.fromCache, t.hasPendingWrites, this.If);
    }
}
...
class rh {
    ...
    data(t) {
        if (zr("DocumentSnapshot.data", arguments, 0, 1), t = Eh("DocumentSnapshot.data", t), 
        this.Fd) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.If) {
                const e = new oh(this.bd, this.Ef, this.Fd, this.kd, this.xd, 
                /* converter= */ null);
                return this.If.fromFirestore(e, t);
            }
            return new Jo(this.bd.Tf, this.bd.pd(), t.serverTimestamps || "none", t => new sh(t, this.bd, /* converter= */ null)).td(this.Fd.Ze());
        }
    }
    get(t, e) {
        if (zr("DocumentSnapshot.get", arguments, 1, 2), e = Eh("DocumentSnapshot.get", e), 
        this.Fd) {
            const n = this.Fd.data().field(Wo("DocumentSnapshot.get", t, this.Ef));
            if (null !== n) {
                return new Jo(this.bd.Tf, this.bd.pd(), e.serverTimestamps || "none", t => new sh(t, this.bd, this.If)).td(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new sh(this.Ef, this.bd, this.If);
    }
    get exists() {
        return null !== this.Fd;
    }
    get metadata() {
        return new ih(this.xd, this.kd);
    }
    isEqual(t) {
        if (!(t instanceof rh)) throw ho("isEqual", "DocumentSnapshot", 1, t);
...
function hh(t, e, n, s, i, r, o) {
    ...
    if (i.O()) {
        ...
        if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
            uh(o, r);
            const e = [];
            for (const n of o) e.push(ch(s, t, n));
            h = {
                arrayValue: {
                    values: e
                }
    ...
    } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || uh(o, r), 
    h = Oo(n, e, o, 
 ...
 */
        ...
        throw n === e.op ? new M($.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new M($.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
    }(t, a), a;
}
...
function ch(t, e, n) {
    ...
    if (n instanceof So) return Gt(t, n.Ef);
    throw new M($.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + io(n) + ".");
}
...
class fh {
    ...
    where(t, e, n) {
        ...
        let s;
        if (Kr("Query.where", arguments, 3), ro("Query.where", 3, n), "not-in" === e || "!=" === e) s = e; else {
            s = eo("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e);
        }
        const i = Wo("Query.where", t), r = hh(this.$d, "Query.where", this.firestore.md, this.firestore.Tf, i, s, n);
        return new fh(function(t, e) {
    ...
    orderBy(t, e) {
        ...
        const s = Wo("Query.orderBy", t), i = ah(this.$d, s, n);
        return new fh(function(t, e) {
    ...
    limit(t) {
        ...
        new fh(vn(this.$d, t, "F" /* First */), this.firestore, this.If);
    }
    limitToLast(t) {
        return Kr("Query.limitToLast", arguments, 1), Hr("Query.limitToLast", "number", 1, t), 
        ao("Query.limitToLast", 1, t), new fh(vn(this.$d, t, "L" /* Last */), this.firestore, this.If);
    }
    startAt(t, ...e) {
        Gr("Query.startAt", arguments, 1);
        const n = this.Md("Query.startAt", t, e, 
        /*before=*/ !0);
        return new fh(Sn(this.$d, n), this.firestore, this.If);
    }
    startAfter(t, ...e) {
    ...
    endBefore(t, ...e) {
        ...
        /*before=*/ !0);
        return new fh(Dn(this.$d, n), this.firestore, this.If);
    }
    endAt(t, ...e) {
    ...
    isEqual(t) {
        if (!(t instanceof fh)) throw ho("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && Cn(this.$d, t.$d) && this.If === t.If;
    }
    withConverter(t) {
        return new fh(this.$d, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    Md(t, e, n, s) {
        if (ro(t, 1, e), e instanceof rh) return Kr(t, [ e, ...n ], 1), function(t, e, n, s, i) {
 ...
 */ (this.$d, this.firestore.Tf, t, e.Fd, s);
    ...
    onSnapshot(...t) {
        ...
        const o = {
            next: e => {
                t[r] && t[r](new dh(this.firestore, this.$d, e, this.If));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
    ...
    get(t) {
        zr("Query.get", arguments, 0, 1), Ih("Query.get", t), _h(this.$d);
        const e = this.firestore.fd();
        return (t && "cache" === t.source ? e.Hf(this.$d) : e.Yf(this.$d, t)).then(t => new dh(this.firestore, this.$d, t, this.If));
    }
}
...
class dh {
    constructor(t, e, n, s) {
        ...
        this.metadata = new ih(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    get query() {
        return new fh(this.Od, this.bd, this.If);
    }
    docChanges(t) {
        ...
        if (e && this.Ld.Bt) throw new M($.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof dh)) throw ho("isEqual", "QuerySnapshot", 1, t);
        return this.bd === t.bd && Cn(this.Od, t.Od) && this.Ld.isEqual(t.Ld) && this.If === t.If;
    }
    Ud(t, e, n) {
        return new oh(this.bd, t.key, t, e, n, this.If);
    }
}

class wh extends fh {
    constructor(t, e, n) {
        if (super(gn(t), e, n), this.Wd = t, t.length % 2 != 1) throw new M($.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t.F()} has ${t.length}`);
    }
    get id() {
    ...
    get parent() {
        ...
        return t._() ? null : new sh(new Q(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
    ...
    doc(t) {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = p.t()), Hr("CollectionReference.doc", "non-empty string", 1, t);
        const e = B.k(t);
        return sh.yd(this.$d.path.child(e), this.firestore, this.If);
    }
    add(t) {
        Kr("CollectionReference.add", arguments, 1);
        Hr("CollectionReference.add", "object", 1, this.If ? this.If.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new wh(this.Wd, this.firestore, t);
    }
}
...
function Th(t, e) {
    ...
    if (oo(t, e, [ "merge", "mergeFields" ]), Xr(t, "boolean", "merge", e.merge), Zr(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof To), 
...
const Ph = {
    ...
    Transaction: eh,
    WriteBatch: nh,
    DocumentReference: sh,
    DocumentSnapshot: rh,
    Query: fh,
    QueryDocumentSnapshot: oh,
    QuerySnapshot: dh,
    CollectionReference: wh,
    FieldPath: To,
    FieldValue: yo,
    setLogLevel: th.setLogLevel,
    CACHE_SIZE_UNLIMITED: Xo
};
...
function Vh(t) {
    !function(t, e) {
        ...
        }, "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Ph)));
    }(t, (t, e) => {
        const n = new Ur, s = new Br(n);
        return new th(t, e, s, n);
    }), t.registerVersion("@firebase/firestore", "1.16.3");
}

Vh(t);

export { Vh as __PRIVATE_registerFirestore };
