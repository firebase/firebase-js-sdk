...
!(function (t, e) {
  ...
  try {
    (function () {
        ...
        r.forEach(function (r) {
          r in e.prototype &&
            (t.prototype[r] = function () {
              return (
                (t = this[n]),
                (e = _(t, r, arguments)).then(function (t) {
                  if (t) return new L(t, e.request);
                })
              );
              var t, e;
            });
      ...
      function M(t, e, r) {
        (this._db = t), (this.oldVersion = e), (this.transaction = new O(r));
      }
      function k(t) {
        this._db = t;
      }
      S(I, '_index', ['name', 'keyPath', 'multiEntry', 'unique']),
        E(I, '_index', IDBIndex, [
          'get',
          'getKey',
          'getAll',
        ...
        T(I, '_index', IDBIndex, ['openCursor', 'openKeyCursor']),
        S(L, '_cursor', ['direction', 'key', 'primaryKey', 'value']),
        E(L, '_cursor', IDBCursor, ['update', 'delete']),
        ...
        S(P, '_store', ['name', 'keyPath', 'indexNames', 'autoIncrement']),
        E(P, '_store', IDBObjectStore, [
          'put',
          'add',
          'delete',
          'clear',
        ...
        T(P, '_store', IDBObjectStore, ['openCursor', 'openKeyCursor']),
        C(P, '_store', IDBObjectStore, ['deleteIndex']),
        (O.prototype.objectStore = function () {
          return new P(this._tx.objectStore.apply(this._tx, arguments));
        }),
        S(O, '_tx', ['objectStoreNames', 'mode']),
        C(O, '_tx', IDBTransaction, ['abort']),
        ...
        C(M, '_db', IDBDatabase, ['deleteObjectStore', 'close']),
        (k.prototype.transaction = function () {
          return new O(this._db.transaction.apply(this._db, arguments));
        }),
        S(k, '_db', ['name', 'version', 'objectStoreNames']),
        C(k, '_db', IDBDatabase, ['close']),
      ...
      var F = '0.4.19',
        ...
        N = 'w:' + F,
        A = 'FIS_v2',
        D = 'https://firebaseinstallations.googleapis.com/v1',
        R = 36e5,
        x =
          (((x = {})['missing-app-config-values'] =
            'Missing App configuration value: "{$valueName}"'),
          (x['not-registered'] = 'Firebase Installation is not registered.'),
          (x['installation-not-found'] = 'Firebase Installation not found.'),
          (x['request-failed'] =
            '{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"'),
          (x['app-offline'] =
            'Could not process request. Application offline.'),
          (x['delete-pending-registration'] =
            "Can't delete installation while there is a pending registration request."),
          x),
        B = new d('installations', 'Installations', x);
      function q(t) {
        return t instanceof h && t.code.includes('request-failed');
      }
      function H(t) {
        t = t.projectId;
        return D + '/projects/' + t + '/installations';
      }
      function K(t) {
        return {
          token: t.token,
      ...
      function U(t, e) {
        ...
        return t.append('Authorization', A + ' ' + e), t;
      }
      function $(r) {
        return f(this, void 0, void 0, function () {
          var e;
      ...
      function Y() {
        try {
          ...
          (self.crypto || self.msCrypto).getRandomValues(t),
            (t[0] = 112 + (t[0] % 16));
          t = (function (t) {
            return btoa(String.fromCharCode.apply(String, n(t)))
              .replace(/\+/g, '-')
              .replace(/\//g, '_');
          })(t).substr(0, 22);
          return W.test(t) ? t : J;
        ...
        return (
          !et &&
            ...
            ((et = new BroadcastChannel(
              ...
              tt(t.data.key, t.data.fid);
            }),
          et
        );
      }
      function nt() {
        0 === Q.size && et && (et.close(), (et = null));
      }
      var it,
        ot,
        st = 'firebase-installations-database',
        at = 1,
        ut = 'firebase-installations-store',
        ct = null;
      function lt() {
        var t, e, r;
        return (
          ct ||
            ((t = at),
            (e = function (t) {
              0 === t.oldVersion && t.createObjectStore(ut);
            }),
            (r = (t = _(indexedDB, 'open', [st, t])).request) &&
              (r.onupgradeneeded = function (t) {
                e && e(new M(r.result, t.oldVersion, r.transaction));
              }),
          ...
          return p(this, function (t) {
            switch (t.label) {
              ...
              case 1:
                return (
                  (n = t.sent()),
                  (r = n.transaction(ut, 'readwrite')),
                  [4, (n = r.objectStore(ut)).get(e)]
                );
              case 2:
              ...
              case 4:
                return t.sent(), (i && i.fid === s.fid) || X(o, s.fid), [2, s];
            }
          });
        });
      }
        ...
        return f(this, void 0, void 0, function () {
          ...
          return p(this, function (t) {
            switch (t.label) {
              ...
              case 7:
                return (
                  t.sent(), !o || (i && i.fid === o.fid) || X(s, o.fid), [2, o]
                );
            }
          });
        });
            ...
            switch (t.label) {
              case 0:
                return [
                  4,
                  pt(i, function (t) {
                    (t = vt(t || { fid: Y(), registrationStatus: 0 })),
                      (t = (function (t, e) {
                        {
                          if (0 !== e.registrationStatus)
                            return 1 === e.registrationStatus
                              ...
                              : { installationEntry: e };
                          if (!navigator.onLine) {
                            var r = Promise.reject(B.create('app-offline'));
                            return {
                              installationEntry: e,
              ...
              case 1:
                return (r = t.sent()).fid !== J ? [3, 3] : ((n = {}), [4, e]);
              case 2:
      ...
      function dt(t) {
        return pt(t, function (t) {
          if (!t) throw B.create('installation-not-found');
          return vt(t);
        });
      }
      function vt(t) {
        return 1 === (e = t).registrationStatus &&
          e.registrationTime + j < Date.now()
        ...
        return f(this, void 0, void 0, function () {
          ...
          return p(this, function (t) {
            switch (t.label) {
              ...
              case 2:
                return (o = t.sent()), [2, K(o)];
              case 3:
                return [4, V('Generate Auth Token', i)];
              case 4:
                throw t.sent();
            }
          });
            ...
            return p(this, function (t) {
              switch (t.label) {
                case 0:
                  return [
                    4,
                    pt(i.appConfig, function (t) {
                      if (!wt(t)) throw B.create('not-registered');
                      var e,
                        r = t.authToken;
                      if (
                        o ||
                        ...
                        (function (t) {
                          ...
                          return (
                            e < t.creationTime ||
                            t.creationTime + t.expiresIn < e + R
                          );
                        })(e)
                      ) {
                                  ...
                                  switch (t.label) {
                                    ...
                                    case 2:
                                      return 1 !== e.authToken.requestStatus
                                        ...
                                        : [4, G(100)];
                                    case 3:
                                      return t.sent(), [4, bt(r.appConfig)];
                                    case 4:
                                      return (e = t.sent()), [3, 2];
                                    case 5:
                                      return 0 ===
      ...
      function bt(t) {
        return pt(t, function (t) {
          if (!wt(t)) throw B.create('not-registered');
          var e = t.authToken;
          return 1 === (e = e).requestStatus && e.requestTime + j < Date.now()
      ...
      function Et(t, n) {
        ...
        return (
          (function (t, e) {
            rt();
            var r = Z(t);
            (t = Q.get(r)) || ((t = new Set()), Q.set(r, t)), t.add(e);
          })(i, n),
          function () {
            var t, e, r;
            (e = n),
              (r = Z((t = i))),
              (t = Q.get(r)) &&
                (t.delete(e), 0 === t.size && Q.delete(r), nt());
          }
        );
      }
      function Ct(t) {
        return B.create('missing-app-config-values', { valueName: t });
      }
      function Tt() {
      ...
      (it = e.default).INTERNAL.registerComponent(
        new y(
          'installations',
          function (t) {
            var e = t.getProvider('app').getImmediate(),
              r = {
                appConfig: (function (t) {
                  var e, r;
                  if (!t || !t.options) throw Ct('App Configuration');
                  if (!t.name) throw Ct('App Name');
                  try {
                    for (
                ...
                return (function (n) {
                  return f(this, void 0, void 0, function () {
                    ...
                    return p(this, function (t) {
                      switch (t.label) {
                        case 0:
                          return [4, gt(n.appConfig)];
                        case 1:
                          return (
                            (e = t.sent()),
                            (r = e.installationEntry),
                            (e.registrationPromise || yt(n)).catch(
                              console.error
                            ),
                            [2, r.fid]
                          );
        ...
        it.registerVersion('@firebase/installations', F),
        ((x = ot = ot || {})[(x.DEBUG = 0)] = 'DEBUG'),
        (x[(x.VERBOSE = 1)] = 'VERBOSE'),
        (x[(x.INFO = 2)] = 'INFO'),
        (x[(x.WARN = 3)] = 'WARN'),
        (x[(x.ERROR = 4)] = 'ERROR'),
        (x[(x.SILENT = 5)] = 'SILENT');
      function It(t, e) {
        ...
        if (!(e < t.logLevel)) {
          ...
          console[o].apply(console, Tt(['[' + i + ']  ' + t.name + ':'], r));
        }
      }
      var Lt = {
          debug: ot.DEBUG,
        ...
        Ot =
          ...
          x),
        Mt =
          (Object.defineProperty(kt.prototype, 'logLevel', {
            get: function () {
          ...
          (kt.prototype.setLogLevel = function (t) {
            this._logLevel = 'string' == typeof t ? Lt[t] : t;
          }),
          Object.defineProperty(kt.prototype, 'logHandler', {
            get: function () {
          ...
          Object.defineProperty(kt.prototype, 'userLogHandler', {
            get: function () {
          ...
          (kt.prototype.debug = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, Tt([this, ot.DEBUG], t)),
              this._logHandler.apply(this, Tt([this, ot.DEBUG], t));
          }),
          (kt.prototype.log = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, Tt([this, ot.VERBOSE], t)),
              this._logHandler.apply(this, Tt([this, ot.VERBOSE], t));
          }),
          (kt.prototype.info = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, Tt([this, ot.INFO], t)),
              this._logHandler.apply(this, Tt([this, ot.INFO], t));
          }),
          (kt.prototype.warn = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, Tt([this, ot.WARN], t)),
              this._logHandler.apply(this, Tt([this, ot.WARN], t));
          }),
          (kt.prototype.error = function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e] = arguments[e];
            this._userLogHandler &&
              this._userLogHandler.apply(this, Tt([this, ot.ERROR], t)),
              this._logHandler.apply(this, Tt([this, ot.ERROR], t));
          }),
          kt);
      function kt(t) {
        (this.name = t),
      ...
      var Ft =
        ((jt.prototype.isCachedDataFresh = function (t, e) {
          if (!e)
            return (
      ...
      var x =
          ...
          (x['registration-project-id'] =
            'Undefined project identifier. Check Firebase app initialization.'),
          (x['registration-api-key'] =
            'Undefined API key. Check Firebase app initialization.'),
          (x['registration-app-id'] =
          ...
          (x['fetch-client-parse'] =
            'Fetch client could not parse response. Original error: {$originalErrorMessage}.'),
          (x['fetch-status'] =
            'Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.'),
          x),
        Nt = new d('remoteconfig', 'Remote Config', x);
      var At =
        ((Dt.prototype.fetch = function (h) {
          return f(this, void 0, void 0, function () {
            var r, n, i, o, s, a, u, c, l, f;
            return p(this, function (t) {
              switch (t.label) {
                case 0:
                  return [
                ...
                case 5:
                  throw (
                    ...
                    Nt.create(o, { originalErrorMessage: i.message }))
                  );
                case 6:
                  if (
                    ((s = f.status),
                ...
                case 10:
                  (u = l.entries), (c = l.state), (t.label = 11);
                case 11:
                  if (
                    ('INSTANCE_STATE_UNSPECIFIED' === c
                      ...
                      : 'NO_CHANGE' === c
                      ? (s = 304)
                      : ('NO_TEMPLATE' !== c && 'EMPTY_CONFIG' !== c) ||
                        (u = {}),
                    304 !== s && 200 !== s)
                  )
                    throw Nt.create('fetch-status', { httpStatus: s });
      ...
      var Rt =
        ((xt.prototype.addEventListener = function (t) {
      ...
      var Bt = ['1', 'true', 't', 'yes', 'y', 'on'],
        qt =
          ((Ht.prototype.asString = function () {
            return this._value;
          }),
          (Ht.prototype.asBoolean = function () {
            return (
              'static' !== this._source &&
              0 <= Bt.indexOf(this._value.toLowerCase())
            );
          }),
          (Ht.prototype.asNumber = function () {
            if ('static' === this._source) return 0;
            var t = Number(this._value);
            return isNaN(t) && (t = 0), t;
          }),
          (Ht.prototype.getSource = function () {
            return this._source;
          }),
          Ht);
      function Ht(t, e) {
      ...
      var Kt =
        ((Vt.prototype.setLogLevel = function (t) {
          switch (t) {
            case 'debug':
              this._logger.logLevel = ot.DEBUG;
              break;
            case 'silent':
              this._logger.logLevel = ot.SILENT;
              break;
            default:
              this._logger.logLevel = ot.ERROR;
          }
        }),
        Object.defineProperty(Vt.prototype, 'fetchTimeMillis', {
          get: function () {
            return (
        ...
        Object.defineProperty(Vt.prototype, 'lastFetchStatus', {
          get: function () {
        ...
        (Vt.prototype.ensureInitialized = function () {
          var t = this;
          return (
              ...
              switch (t.label) {
                ...
                case 1:
                  return (
                    ...
                    [
                      4,
                      this._client.fetch({
                        cacheMaxAgeMillis: this.settings
                ...
                case 4:
                  return (
                    ...
                    (r = 'fetch-throttle'),
                    (o =
                      (e = i) instanceof h && -1 !== e.code.indexOf(r)
                        ? 'throttle'
                        : 'failure'),
        ...
        (Vt.prototype.fetchAndActivate = function () {
          return f(this, void 0, void 0, function () {
            return p(this, function (t) {
              switch (t.label) {
                case 0:
        ...
        (Vt.prototype.getBoolean = function (t) {
          return this.getValue(t).asBoolean();
        }),
        (Vt.prototype.getNumber = function (t) {
          return this.getValue(t).asNumber();
        }),
        (Vt.prototype.getString = function (t) {
        ...
        (Vt.prototype.getValue = function (t) {
          ...
          return e && void 0 !== e[t]
            ...
            ? new qt('default', String(this.defaultConfig[t]))
            : (this._logger.debug(
      ...
      function zt(t, e) {
        ...
        return Nt.create(e, { originalErrorMessage: t && t.message });
      }
      var Ut = 'app_namespace_store',
        $t = 'firebase_remote_config',
        Gt = 1;
      var Wt =
        ((Jt.prototype.getLastFetchStatus = function () {
          return this.get('last_fetch_status');
        }),
        (Jt.prototype.setLastFetchStatus = function (t) {
          return this.set('last_fetch_status', t);
        }),
        (Jt.prototype.getLastSuccessfulFetchTimestampMillis = function () {
          return this.get('last_successful_fetch_timestamp_millis');
        }),
        (Jt.prototype.setLastSuccessfulFetchTimestampMillis = function (t) {
          return this.set('last_successful_fetch_timestamp_millis', t);
        }),
        (Jt.prototype.getLastSuccessfulFetchResponse = function () {
          return this.get('last_successful_fetch_response');
        }),
        (Jt.prototype.setLastSuccessfulFetchResponse = function (t) {
          return this.set('last_successful_fetch_response', t);
        }),
        (Jt.prototype.getActiveConfig = function () {
          return this.get('active_config');
        }),
        (Jt.prototype.setActiveConfig = function (t) {
          return this.set('active_config', t);
        }),
        (Jt.prototype.getActiveConfigEtag = function () {
          return this.get('active_config_etag');
        }),
        (Jt.prototype.setActiveConfigEtag = function (t) {
          return this.set('active_config_etag', t);
        }),
        (Jt.prototype.getThrottleMetadata = function () {
          return this.get('throttle_metadata');
        }),
        (Jt.prototype.setThrottleMetadata = function (t) {
          return this.set('throttle_metadata', t);
        }),
        (Jt.prototype.deleteThrottleMetadata = function () {
          return this.delete('throttle_metadata');
        }),
        (Jt.prototype.get = function (a) {
          return f(this, void 0, void 0, function () {
            var o,
              s = this;
            return p(this, function (t) {
                  ...
                  return (
                    ...
                    [
                      ...
                      new Promise(function (e, r) {
                        var t = o.transaction([Ut], 'readonly').objectStore(Ut),
                    ...
                    [
                      ...
                      new Promise(function (t, e) {
                        var r = o
                          ...
                          n = s.createCompositeKey(a);
                        try {
                          var i = r.put({ compositeKey: n, value: u });
                          (i.onerror = function (t) {
                            e(zt(t, 'storage-set'));
                          }),
        ...
        (Jt.prototype.delete = function (a) {
          return f(this, void 0, void 0, function () {
            var o,
              s = this;
            return p(this, function (t) {
        ...
        (Jt.prototype.createCompositeKey = function (t) {
          ...
          (n = new Promise(function (e, r) {
            ...
            (t.onerror = function (t) {
              ...
              (t.onupgradeneeded = function (t) {
                ...
                0 === t.oldVersion &&
                  e.createObjectStore(Ut, { keyPath: 'compositeKey' });
              });
          })),
          (this.appId = t),
          (this.appName = e),
      ...
      var Yt =
        ((Zt.prototype.getLastFetchStatus = function () {
          return this.lastFetchStatus;
        }),
        (Zt.prototype.getLastSuccessfulFetchTimestampMillis = function () {
          return this.lastSuccessfulFetchTimestampMillis;
        }),
        (Zt.prototype.getActiveConfig = function () {
          return this.activeConfig;
        }),
        (Zt.prototype.loadFromStorage = function () {
          return f(this, void 0, void 0, function () {
            var e, r, n;
            return p(this, function (t) {
              switch (t.label) {
      ...
      var Qt =
        ...
        (Xt.prototype.attemptFetch = function (u, t) {
          var c = t.throttleEndTimeMillis,
            l = t.backoffCount;
          return f(this, void 0, void 0, function () {
            var s, a;
            return p(this, function (t) {
              switch (t.label) {
                ...
                case 1:
                  t.sent(), (t.label = 2);
                case 2:
                  return t.trys.push([2, 5, , 7]), [4, this.client.fetch(u)];
                case 3:
                  return (
                ...
                case 6:
                  return t.sent(), [2, this.attemptFetch(u, a)];
                case 7:
                  return [2];
              }
              var e, r, n, i, o;
      ...
      (te = e.default).INTERNAL.registerComponent(
        new y(
          'remoteConfig',
          function (t, e) {
            var r = t.getProvider('app').getImmediate(),
              n = t.getProvider('installations').getImmediate();
            ...
            var i = r.options,
              ...
              s = i.apiKey,
              a = i.appId;
            if (!o) throw Nt.create('registration-project-id');
            if (!s) throw Nt.create('registration-api-key');
            if (!a) throw Nt.create('registration-app-id');
            e = e || 'firebase';
            var u = new Wt(a, r.name, e),
              t = new Yt(u),
              i = new Mt(ee);
            i.logLevel = ot.ERROR;
            (a = new At(n, te.SDK_VERSION, e, o, s, a)),
              (a = new Qt(a, u)),
              (a = new Ft(a, u, t, i)),
              (i = new Kt(r, a, t, u, i));
