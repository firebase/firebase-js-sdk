 ...
 */
export declare function getBlob(
 ...
 */
export declare function getStream(
  ref: StorageReference,
  maxDownloadSizeBytes?: number
): ReadableStream;
 ...
 */
declare type RequestHandler<I extends ConnectionType, O> = (
 ...
 */
declare type Subscribe_2<T> = (
  next?: NextFn_2<T> | StorageObserver_2<T>,
  error?: ErrorFn,
  complete?: CompleteFn_2
) => Unsubscribe_2;
 ...
 */
export declare function uploadBytesResumable(
  ref: StorageReference,
  data: Blob | Uint8Array | ArrayBuffer,
  metadata?: UploadMetadata
): UploadTask;
 ...
 * @returns A Promise containing an UploadResult
 */
export declare function uploadString(
  ref: StorageReference,
  value: string,
  format?: StringFormat,
  metadata?: UploadMetadata
