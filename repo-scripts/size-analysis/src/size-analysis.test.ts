...
import { retrieveTestModuleDtsFile } from '../test-utils/setup';
...
//   before(() => {
//     const testModuleDtsFile = retrieveTestModuleDtsFile();
//     console.log(testModuleDtsFile);
//     const extractedDeclarations = extractDeclarations(testModuleDtsFile);
//   });
//   it('test basic variable extractions', () => { });

//   it('test re-exported variable extractions', () => { });
// });
