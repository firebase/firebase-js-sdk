...
export class LiveSession {
  ...
  // @internal
  constructor(
    _setupMessage: _LiveClientSetup,
    _apiSettings: ApiSettings,
    _sessionResumption?: SessionResumptionConfig | undefined,
...
export abstract class Schema implements SchemaInterface {
  ...
  // (undocumented)
  static anyOf(
    anyOfParams: SchemaParams & {
      anyOf: TypedSchema[];
    }
  ): AnyOfSchema;
  // (undocumented)
  static array(
    arrayParams: SchemaParams & {
      items: Schema;
    }
  ): ArraySchema;
  // (undocumented)
